...
`;var Hn=`This Player provides access to thousands of free recordings
...
`;function Wn({mediaType:t="audio",panel:a=!1}={}){let r=t==="video",n=r?{genre:"Film Types",artist:"Collections",album:"Movies",find:"Find a film\u2026",addGenre:"+ Add film type",addArtist:"+ Add collection"}:{genre:"Genres",artist:"Artists",album:"Albums",find:"Find artist\u2026",addGenre:"+ Add genre",addArtist:"+ Add artist"},s='<video class="ia-audio ia-video" aria-label="Media player" playsinline controls></video>',o=document.createElement("div");o.className="ia-player-app"+(r?" media-video":" media-audio"),o.setAttribute("role","region"),o.setAttribute("aria-label",r?"Open Media Player (movies)":"Open Media Player"),o.innerHTML=`
  ...
  `,document.body.appendChild(u);let v=ca(u),y=()=>{u.remove(),v()};u.querySelector(".about-modal-close").addEventListener("click",y),u.addEventListener("click",m=>{m.target===u&&y()}),document.addEventListener("keydown",function m(b){b.key==="Escape"&&(y(),document.removeEventListener("keydown",m))})}function ei({filter:t,onSave:a}){let r=document.querySelector(".about-modal");r&&r.remove();let n=t||{},s=(n.blockedCollections||[]).join(", "),o=Gn(n.minTrackDurationSec||0),l=Gn(n.minItemRuntimeSec||0),u=document.createElement("div");u.className="about-modal",u.innerHTML=`
  ...
  `,document.body.appendChild(l);let u=ca(l),p=l.querySelector("form"),v=()=>{l.remove(),u()};l.querySelector(".about-modal-close").addEventListener("click",v),l.querySelector(".filters-cancel").addEventListener("click",v),l.addEventListener("click",y=>{y.target===l&&v()}),document.addEventListener("keydown",function y(m){m.key==="Escape"&&(v(),document.removeEventListener("keydown",y))}),ai(l,r,v),p.addEventListener("submit",y=>{y.preventDefault();let m=p.elements.name.value.trim();if(!m){p.elements.name.focus();return}n?.({name:m,maker:p.elements.maker.value.trim(),description:p.elements.description.value.trim()}),v()}),p.elements.name.focus(),p.elements.name.select()}function ri({title:t="Edit library",values:a={},canDelete:r=!1,onSave:n,onDelete:s}){let o=document.querySelector(".about-modal");o&&o.remove();let l=a||{},u=document.createElement("div");u.className="about-modal",u.innerHTML=`
  ...
  `,document.body.appendChild(u);let p=ca(u),v=u.querySelector("form"),y=()=>{u.remove(),p()};u.querySelector(".about-modal-close").addEventListener("click",y),u.querySelector(".filters-cancel").addEventListener("click",y),u.addEventListener("click",m=>{m.target===u&&y()}),document.addEventListener("keydown",function m(b){b.key==="Escape"&&(y(),document.removeEventListener("keydown",m))}),ai(u,r,y),v.addEventListener("submit",m=>{m.preventDefault();let b=v.elements.title.value.trim();if(!b){v.elements.title.focus();return}n?.({title:b,artist:v.elements.artist.value.trim(),album:v.elements.album.value.trim()}),y()}),v.elements.title.focus(),v.elements.title.select()}function $(t,a){t.textContent=a}function ii(t,a){t.innerHTML="";let r=document.createElement("div");r.className="music-player",r.innerHTML=`
  ...
  `,t.appendChild(r);let n=r.querySelector(".rdf-uri"),s=r.querySelector(".load-btn"),o=()=>{let l=n.value.trim();l&&a(l)};s.addEventListener("click",o),n.addEventListener("keypress",l=>{l.key==="Enter"&&o()})}function oi(t){t.innerHTML='<div class="loading-screen">Loading music library...</div>'}function si(t,a){t.innerHTML=`<div class="error">Error loading music player: ${a}</div>`}function li(t,a){t.innerHTML="",t.appendChild(a)}Zn({css:qn,aboutHtml:Hn});import*as us from"rdflib";var ci=Object.freeze({READY:"swc:ready",CAPABILITY:"swc:capability",OFFER:"swc:offer",LOGIN:"sol-login",LOGOUT:"sol-logout",AUTH_NEEDED:"sol-auth-needed",DEFAULT_CHANGE:"sol-default-change",COMMAND:"sol-command",ERROR:"sol-error",FORM_SAVE:"sol-form-save"});function cs(){let t=new Map,a=new Map;return{register(r,n){t.set(r,n);let s=a.get(r);s&&(a.delete(r),s.forEach(o=>o(n)))},get(r){return t.get(r)},has(r){return t.has(r)},names(){return Array.from(t.keys())},whenReady(r){return t.has(r)?Promise.resolve(t.get(r)):new Promise(n=>{let s=a.get(r)||[];s.push(n),a.set(r,s)})}}}var di=null;function _r(){if(typeof window<"u"){let t=window.ComponentInterop||window.SolidWebComponents||{};return window.ComponentInterop=t,window.SolidWebComponents=t,t}return di=di||{}}function ds(){let t=_r();return t.services||(t.services=cs()),t.EVENTS||(t.EVENTS=ci),t.services}function fi(t,a){return ds().register(t,a)}function ui(t,a){let r=_r();return r.adoptedFetch=typeof t=="function"?t:null,a&&a.webId&&(r.adoptedWebId=a.webId),r.adoptedFetch}if(typeof window<"u"){let t=_r();t.adoptFetch||(t.adoptFetch=ui),typeof t.registerConsumer=="function"&&t.registerConsumer("adoptFetch",a=>ui(a))}var me=us,Na=class{constructor(){this._store=null,this._fetcher=null,this._adopted=!1,this._loaded=new Set,this._changeSubs=new Set,this._wiredStore=null,this._flushPending=!1}markLoaded(a){this._loaded.add(a)}isLoaded(a){return this._loaded.has(a)}sym(a){return me.sym(a)}literal(a,r,n){return n!==void 0?me.literal(a,r,n):me.literal(a,r)}blankNode(a){return me.blankNode(a)}graph(){return me.graph()}parse(a,r,n,s){return me.parse(a,r,n,s)}st(a,r,n,s){return me.st(a,r,n,s)}get store(){if(this._adopted&&this._store)return this._store;let a=typeof window<"u"&&(window[Symbol.for("solid-logic-singleton")]||window.SolidLogic);return a?.store?(this._store=a.store,a.store):(this._store||(this._store=me.graph()),this._store)}useStore(a){return!a||typeof a.match!="function"?!1:(this._store=a,this._fetcher=a.fetcher||null,this._adopted=!0,this._loaded.clear(),this._wireChange(a),!0)}onChange(a,r,n,s){let o={pattern:{subject:a,predicate:r,object:n},cb:s,dirty:!1};return this._changeSubs.add(o),this._wireChange(this.store),()=>this._changeSubs.delete(o)}_matchesPattern(a,r){return(!a.subject||r.subject&&r.subject.equals(a.subject))&&(!a.predicate||r.predicate&&r.predicate.equals(a.predicate))&&(!a.object||r.object&&r.object.equals(a.object))}_wireChange(a){if(!a||this._wiredStore===a)return;this._wiredStore=a;let r=n=>{let s=!1;for(let o of this._changeSubs)!o.dirty&&this._matchesPattern(o.pattern,n)&&(o.dirty=!0,s=!0);s&&this._scheduleFlush()};typeof a.addDataCallback=="function"&&a.addDataCallback(r),typeof a.addDataRemovalCallback=="function"&&a.addDataRemovalCallback(r)}_scheduleFlush(){this._flushPending||(this._flushPending=!0,queueMicrotask(()=>{this._flushPending=!1;for(let a of this._changeSubs)if(a.dirty){a.dirty=!1;try{a.cb()}catch(r){console.error("[rdf] onChange subscriber failed",r)}}}))}get storeFetcher(){return this._fetcher?this._fetcher:this.store.fetcher?(this._fetcher=this.store.fetcher,this._fetcher):(this._fetcher=new me.Fetcher(this.store),this.store.fetcher=this._fetcher,this._fetcher)}async load(a){let r=String(a).split("#")[0];return this.isLoaded(r)||(await this.storeFetcher.load(r),this.markLoaded(r)),this.store}fetcher(a,r){return new me.Fetcher(a,r)}sparqlToQuery(a,r,n){return me.SPARQLToQuery(a,r,n)}sparqlQuery(a,r){return me.sparqlQuery(a,r)}isReady(){return!!me&&typeof me.graph=="function"}hasSparqlEngine(){return typeof me.SPARQLToQuery=="function"}hasRemoteSparql(){return typeof me.sparqlQuery=="function"}serialize(a,r,n,s){return me.serialize(a,r,n,s)}get UpdateManager(){return me.UpdateManager}get SPARQLToQuery(){return me.SPARQLToQuery}get Fetcher(){return me.Fetcher}get NamedNode(){return me.NamedNode}get BlankNode(){return me.BlankNode}get Literal(){return me.Literal}get Collection(){return me.Collection}get Statement(){return me.Statement}},pi=Symbol.for("sol-components:rdf-singleton"),W=typeof window<"u"?window[pi]||(window[pi]=new Na):new Na,we=W;fi("rdf",W);typeof window<"u"&&window.SolidWebComponents&&typeof window.SolidWebComponents.registerConsumer=="function"&&window.SolidWebComponents.registerConsumer("rdf.useStore",function(t){W.useStore(t)});var de={rdf:"http://www.w3.org/1999/02/22-rdf-syntax-ns#",schema:"http://schema.org/",dcat:"http://www.w3.org/ns/dcat#",dct:"http://purl.org/dc/terms/",skos:"http://www.w3.org/2004/02/skos/core#"},Ne=t=>W.sym(t),zt=t=>W.literal(String(t)),fs=Ne(de.rdf+"type");function mi(t,a){let r=Ne(a.iri);return t.add(r,fs,Ne(de.schema+"ImageObject")),a.thumb&&t.add(r,Ne(de.schema+"thumbnailUrl"),Ne(a.thumb)),a.full&&t.add(r,Ne(de.schema+"contentUrl"),Ne(a.full)),a.width&&t.add(r,Ne(de.schema+"width"),zt(a.width)),a.height&&t.add(r,Ne(de.schema+"height"),zt(a.height)),a.caption&&t.add(r,Ne(de.schema+"caption"),zt(a.caption)),a.license&&t.add(r,Ne(de.schema+"license"),zt(a.license)),a.author&&t.add(r,Ne(de.schema+"author"),zt(a.author)),a.detailUrl&&t.add(r,Ne(de.schema+"mainEntityOfPage"),Ne(a.detailUrl)),a.position!=null&&t.add(r,Ne(de.schema+"position"),zt(a.position)),r}var ps="https://commons.wikimedia.org/w/api.php";function hi(t){return t?(new DOMParser().parseFromString(String(t),"text/html").body.textContent||"").replace(/\s+/g," ").trim():""}function ms(t){if(!t)return"";let a="";try{let r=new URL(t),n=r.pathname.match(/\/wiki\/(.+)$/);a=n?n[1]:r.searchParams.get("title")||""}catch{let r=String(t).match(/Category:[^?#]+/);a=r?r[0]:""}try{a=decodeURIComponent(a)}catch{}return a=a.replace(/_/g," ").trim(),/^Category:/i.test(a)?a:""}async function bi(t,a={}){let{thumbWidth:r=300,limit:n=60,cont:s,signal:o}=a,l=ms(t);if(!l)throw new Error("Not a Commons category URL");let u=new URLSearchParams({action:"query",format:"json",origin:"*",generator:"categorymembers",gcmtitle:l,gcmtype:"file",gcmlimit:String(n),prop:"imageinfo",iiprop:"url|size|extmetadata",iiurlwidth:String(r),iiextmetadatafilter:"Artist|LicenseShortName"});s&&u.set("gcmcontinue",s);let p=await fetch(`${ps}?${u}`,{signal:o});if(!p.ok)throw new Error(`HTTP ${p.status} from Commons`);let v=await p.json();if(v.error)throw new Error(v.error.info||"Commons API error");let y=v.query&&v.query.pages?Object.values(v.query.pages):[];y.sort((g,f)=>(g.index||0)-(f.index||0));let m=[];for(let g of y){let f=g.imageinfo&&g.imageinfo[0];if(!f||!f.thumburl)continue;let S=f.extmetadata||{};m.push({title:(g.title||"").replace(/^File:/,""),name:g.title||"",thumb:f.thumburl,full:f.url,width:f.thumbwidth||0,height:f.thumbheight||0,descUrl:f.descriptionurl||"",artist:hi(S.Artist&&S.Artist.value),license:hi(S.LicenseShortName&&S.LicenseShortName.value)})}let b=v.continue&&v.continue.gcmcontinue?v.continue.gcmcontinue:null;return{images:m,cont:b}}function hs(t,{startIndex:a=0}={}){let r=W.graph();return t.forEach((n,s)=>{let o=a+s,l=n.descUrl||n.full||`urn:commons:image:${o}`;mi(r,{iri:l,thumb:n.thumb,full:n.full,width:n.width,height:n.height,caption:n.title,license:n.license,author:n.artist,detailUrl:n.descUrl,position:o})}),r}async function*gi(t,{pageSize:a=60,thumbWidth:r=300,signal:n}={}){let s,o=0;do{let{images:l,cont:u}=await bi(t,{thumbWidth:r,limit:a,cont:s,signal:n});yield hs(l,{startIndex:o}),o+=l.length,s=u}while(s)}var Le={rdf:"http://www.w3.org/1999/02/22-rdf-syntax-ns#",schema:"http://schema.org/",dct:"http://purl.org/dc/terms/",dcat:"http://www.w3.org/ns/dcat#",dctype:"http://purl.org/dc/dcmitype/",ldp:"http://www.w3.org/ns/ldp#",xsd:"http://www.w3.org/2001/XMLSchema#"},$r=()=>new URL("favourites/",document.baseURI).href,Ar=t=>JSON.stringify(String(t));function bs(t){let a=t.created||new Date().toISOString(),r=`<${t.item}> a dctype:${t.bucket}, schema:${t.schemaType} ;
...
`;function xs(t){return new Promise(a=>{let r=document.createElement("div");r.className="omp-fav-overlay",r.innerHTML=`<style>${ws}</style>
      ...
      </div>`,document.body.appendChild(r);let n=r.querySelector(".omp-fav-title");n.value=t||"",n.focus(),n.select?.();let s=l=>{r.remove(),a(l)},o=()=>{let l=n.value.trim();s({contributor:vs()||"anonymous",title:l||t})};r.querySelector(".omp-fav-cancel").addEventListener("click",()=>s(null)),r.querySelector(".omp-fav-add").addEventListener("click",o),r.addEventListener("click",l=>{l.target===r&&s(null)}),r.addEventListener("keydown",l=>{l.key==="Escape"?s(null):l.key==="Enter"&&(l.preventDefault(),o())})})}async function Tr(t){let a=await xs(t.name);if(!a)return null;let r={...t,contributor:a.contributor,title:a.title};return await yi(r),document.dispatchEvent(new CustomEvent("omp:favourited",{detail:r})),r}function vi(){window.__ompFavRouter||(window.__ompFavRouter=!0,document.addEventListener("item-favourite",t=>{let a=t.detail;a&&a.bucket&&a.item&&Tr(a).catch(r=>console.warn("[favourite]",r.message))}))}var ks=`
...
`,n=await fetch(this._docUrl(),{method:"PATCH",headers:{"Content-Type":"application/sparql-update"},body:r});if(!n.ok)throw new Error(`Save failed (HTTP ${n.status}). The file must be on a Solid pod you own.`)}_docUrl(){return new URL(this.source,document.baseURI).href.split("#")[0]}_schemeIri(){let a=this.source.split("#")[1]||"Images";return`${this._docUrl()}#${a}`}_selKey(){return`omp-images:collection:${this.source}`}_mintIri(a,r){let n=(r?r+"-":"")+a.trim().replace(/[^A-Za-z0-9]+/g,"_").replace(/^_+|_+$/g,"").slice(0,40),s=n||"item",o=this._docUrl(),l=p=>this._topicByIri.has(`${o}#${p}`)||this._libraries.some(v=>v.iri===`${o}#${p}`)||this._collByIri.has(`${o}#${p}`),u=2;for(;l(s);)s=`${n}_${u++}`;return`${o}#${s}`}_syncOwner(){let a=!!document.querySelector("sol-default")?.hasAttribute("solid-kitchen")||!!document.querySelector("sol-login")?.isLoggedIn;this.classList.toggle("owner",a)}};customElements.get("omp-images")||customElements.define("omp-images",Er);function Cr(t){if(!t)return null;let a;try{a=new URL(t)}catch{return null}let r=a.pathname.match(/\/details\/([^/?]+)/);if(r)return`collection:${r[1]}`;if(a.pathname==="/search"||a.pathname==="/search.php"){let n=[],s=(a.searchParams.get("query")||"").trim();s&&n.push(s);for(let o of a.searchParams.getAll("and[]")){let l=o.trim();l&&n.push(l)}return n.length?n.join(" AND "):null}return null}function xi(t){if(t==null)return NaN;if(typeof t=="number")return t;let a=String(t).trim();if(!a)return NaN;if(/^[0-9.]+$/.test(a))return parseFloat(a);let r=a.split(":").map(Number);return r.some(n=>!Number.isFinite(n))?NaN:r.length===3?r[0]*3600+r[1]*60+r[2]:r.length===2?r[0]*60+r[1]:r[0]}function Ss(t){return/^collection:/.test(t)}function Ls(t){return t==="video"?"movies":"audio"}async function Ir(t,a=null,r={}){if(!t)return[];let n=Ls(r.mediaType),s=t,o=a&&(!Ss(t)||a.applyToCatalogArtists);if(o){let m=[];t.includes("mediatype:")||m.push(`mediatype:"${n}"`),a.minDownloads>0&&m.push(`downloads:[${a.minDownloads} TO *]`);for(let b of a.blockedCollections||[]){let g=String(b).trim();g&&m.push(`-collection:"${g}"`)}m.length&&(s=`(${t}) AND ${m.join(" AND ")}`)}let l=new URLSearchParams({q:s,output:"json",rows:1e4});for(let m of["identifier","title","downloads","runtime","collection","creator","format","licenseurl","rights","possible-copyright-status"])l.append("fl[]",m);let u=`https://archive.org/advancedsearch.php?${l}`,p=await fetch(u);if(!p.ok)throw new Error(`HTTP error! status: ${p.status}`);let v=await p.json(),y=[];if(v.response&&v.response.docs)for(let m of v.response.docs)m.identifier&&y.push({name:m.title||m.identifier,url:`https://archive.org/details/${m.identifier}`,_downloads:m.downloads,_runtime:m.runtime,_collection:m.collection,_creator:m.creator,_format:m.format,_rights:ki(m),_detailUrl:`https://archive.org/details/${m.identifier}`});if(o){let m=(a.blockedCollections||[]).map(b=>String(b).trim()).filter(Boolean);y=y.filter(b=>{if(a.minItemRuntimeSec>0&&b._runtime!=null){let g=xi(b._runtime);if(Number.isFinite(g)&&g<a.minItemRuntimeSec)return!1}return!(m.length&&b._collection&&(Array.isArray(b._collection)?b._collection:[b._collection]).some(f=>m.includes(f)))})}return r.mediaType==="video"&&(y=y.filter(m=>{let b=Array.isArray(m._format)?m._format:m._format?[m._format]:[];return!b.length||b.some(g=>Es.test(g))}),y=_s(y)),y}function _s(t){let a=s=>{let o=parseInt(s._downloads,10);return Number.isFinite(o)?o:0},r=new Map,n=[];for(let s of t){let o=String(s.name||"").toLowerCase().replace(/\s+/g," ").trim();if(!o){n.push(s);continue}let l=r.get(o);(!l||a(s)>a(l))&&r.set(o,s)}return[...r.values(),...n].sort((s,o)=>a(o)-a(s))}var As="https://archive.org/metadata/",$s=[".mp3",".m4a",".aac",".ogg",".oga",".opus",".webm",".weba",".flac",".wav"],Ts=[".mp4",".m4v",".ogv",".webm",".mov"],Es=/(h\.?264|mpeg-?4|ogg\s*video|web ?m|quicktime|matroska)/i,Cs=t=>t==="video"?Ts:$s,Is=t=>new RegExp("("+t.map(a=>"\\"+a).join("|")+")$","i");function Ps(t){return t.source==="derivative"&&t.original?t.original:t.name}function Ds(t,a){for(let r of a){let n=t.find(s=>s.name&&s.name.toLowerCase().endsWith(r));if(n)return n}return null}var wi={NOT_IN_COPYRIGHT:"Public domain",PUBLIC_DOMAIN:"Public domain",IN_COPYRIGHT:"In copyright",UNKNOWN:"Rights unknown"};function Us(t){let a=/creativecommons\.org\/(licenses|publicdomain)\/([a-z0-9-]+)(?:\/([0-9.]+))?/i.exec(t||"");if(!a)return"";let r=a[2].toLowerCase();return a[1].toLowerCase()==="publicdomain"||r==="zero"||r==="mark"?"Public domain (CC)":`CC ${r.toUpperCase()}${a[3]?" "+a[3]:""}`}function Ms(t,a,r){let n=Us(t);return n||(r&&wi[r]?wi[r]:a?a.length>70?a.slice(0,67)+"\u2026":a:r?r.replace(/_/g," ").toLowerCase():t?"Licensed (see IA)":"")}function ki(t){if(!t)return null;let a=l=>Array.isArray(l)?l[0]:l,r=a(t.licenseurl)||"",n=(a(t.rights)||"").toString().trim(),s=a(t["possible-copyright-status"])||"",o=Ms(r,n,s);return o?{label:o,licenseUrl:r,rights:n,status:s}:null}async function Si(t,a=null,r={}){if(!t)return[];let n=Cs(r.mediaType),s=Is(n),o=await fetch(`${As}${t}`);if(!o.ok)throw new Error(`IA metadata ${o.status} for ${t}`);let l=await o.json();if(!l.metadata)throw new Error(`Empty metadata for ${t}`);let u=l.metadata||{};if(u["access-restricted-item"]==="true"||u["access-restricted"]==="true"||u.is_dark==="true")return[];let v=ki(u),y=`https://archive.org/details/${t}`,m=l.files||[],b=new Map;for(let F of m){if(!F.name||!s.test(F.name)||F.private==="true")continue;let B=Ps(F);b.has(B)||b.set(B,[]),b.get(B).push(F)}let g=Array.isArray(u.creator)?u.creator[0]:u.creator,f=g?String(g).trim():"",D=/^(various(\s+artists?)?|v\.?a\.?)$/i.test(f)?"":f,I=[];for(let F of b.values()){let B=Ds(F,n);if(!B)continue;let ce=B.length||F.find(C=>C.length)?.length,ne=B.title||F.find(C=>C.title)?.title,xe=B.bitrate||F.find(C=>C.bitrate)?.bitrate,ze=B.artist||B.creator||F.find(C=>C.artist)?.artist||F.find(C=>C.creator)?.creator||"",Ke=String(ze).trim()||D;I.push({url:`https://archive.org/download/${t}/${encodeURIComponent(B.name)}`,name:ne||B.name.replace(/\.[^.]+$/,""),time:Rs(ce),artist:Ke,_rights:v,_detailUrl:y,_lengthSec:xi(ce),_bitrate:xe!=null?parseFloat(xe):NaN})}return a?I.filter(F=>!(a.minTrackDurationSec>0&&Number.isFinite(F._lengthSec)&&F._lengthSec<a.minTrackDurationSec||a.minTrackBitrateKbps>0&&Number.isFinite(F._bitrate)&&F._bitrate<a.minTrackBitrateKbps)):I}function Rs(t){if(!t)return"";if(/^\d+:\d+/.test(t))return t.split(":").slice(-2).join(":");let a=parseFloat(t);if(!isFinite(a))return"";let r=Math.floor(a/60),n=Math.floor(a%60);return`${r}:${n.toString().padStart(2,"0")}`}import{Namespace as Fe,graph as _t,Fetcher as Pr,sym as R,st as P,literal as Q,UpdateManager as Li,parse as jt}from"rdflib";function za(t,a={}){let r=a.element||Ns(),n=a.tag||a.element&&typeof a.element.getAttribute=="function"&&a.element.getAttribute("side")||"default";if(r&&typeof r.fetchFor=="function")try{let o=r.fetchFor(t,n);if(typeof o=="function")return o}catch{}let s=typeof window<"u"&&window.SolidWebComponents?.adoptedFetch;return typeof s=="function"?s:typeof globalThis.fetch=="function"?globalThis.fetch.bind(globalThis):void 0}function Ns(){return typeof document>"u"?null:document.querySelector("sol-login")}var zl=5*60*1e3;var st=Fe("http://www.w3.org/2004/02/skos/core#"),lt=Fe("http://www.w3.org/2000/01/rdf-schema#"),oe=Fe("http://www.w3.org/1999/02/22-rdf-syntax-ns#"),ft=Fe("http://www.w3.org/2001/XMLSchema#"),q=Fe("http://purl.org/dc/terms/"),ye=Fe("http://xmlns.com/foaf/0.1/"),J=Fe("http://purl.org/ontology/mo/"),se=Fe("http://www.w3.org/ns/dcat#"),O=Fe("http://schema.org/"),Mr=Fe("http://www.w3.org/ns/oa#"),Je=Fe("http://www.w3.org/ns/solid/terms#"),Fs=Fe("http://purl.org/dc/dcmitype/"),Nr=J("MusicArtist"),Bt=J("Release"),Dr=J("Track"),Ot=O("MusicPlaylist"),zs=J("Genre");function $e(t){let a=new URL("./",t);return{libraryDoc:R(t),agentsDoc:R(new URL("agents.ttl",a).href),genresDoc:R(new URL("genres.ttl",a).href),releasesDoc:R(new URL("releases.ttl",a).href),releasesIndexDoc:R(new URL("releases.ttl",a).href),releasesCatalog:R(new URL("releases.ttl",a).href+"#it"),playlistsDoc:R(new URL("playlists.ttl",a).href),playlistsCatalog:R(new URL("playlists.ttl",a).href+"#it"),releasesDirUrl:new URL("releases/",a).href,playlistsDirUrl:new URL("playlists/",a).href,musicRootUri:new URL("genres.ttl",a).href+"#Music"}}function Fr(t){return String(t).trim().replace(/[^\w]+/g,"_").replace(/^_+|_+$/g,"").slice(0,80)||"Playlist"}function js(t,a,r){let n=$e(a),s=n.libraryDoc,o=new Set;for(let v of t.match(n.playlistsCatalog,se("dataset"),null))o.add(v.object.value.split("#")[0]);for(let v of t.match(s,lt("seeAlso"),null))o.add(v.object.value);let l=Fr(r),u=n.playlistsDirUrl+l,p=1;for(;o.has(u);)u=n.playlistsDirUrl+l+"_"+p,p++;return u.slice(n.playlistsDirUrl.length)}function Bs(t,a,r,n){let s=new Set(n||[]);for(let p of t.match(a.releasesCatalog,se("dataset"),null))s.add(p.object.value.split("#")[0]);for(let p of t.match(a.releasesDoc,lt("seeAlso"),null))s.add(p.object.value);let o=Fr(r).toLowerCase()||"release",l=a.releasesDirUrl+o,u=1;for(;s.has(l);)l=a.releasesDirUrl+o+"_"+u++;return l}function Oa(t,a,r){let n="/"+String(a)+"/",s=(String(r).match(/\//g)||[]).length,o=s?"../".repeat(s):"./";return String(t).replace(/<(https?:\/\/[^>\s]+)>/g,(l,u)=>{let p=u.indexOf(n);if(p<0)return l;let v=u.slice(p+n.length);return v?`<${o}${v}>`:l})}var zr="omp-spine-v1",Os=7*24*60*60*1e3,qa=()=>typeof caches<"u";async function qs(t){if(!qa())return null;try{let a=await caches.open(zr),r=await a.match(t);if(!r)return null;let n=Number(r.headers.get("x-omp-cached-at")||0);return n&&Date.now()-n>Os?(a.delete(t),null):await r.text()}catch{return null}}async function Hs(t,a,r="text/turtle"){if(!(!qa()||a==null))try{await(await caches.open(zr)).put(t,new Response(a,{headers:{"Content-Type":r,"x-omp-cached-at":String(Date.now())}}))}catch{}}function Rr(...t){qa()&&caches.open(zr).then(a=>{for(let r of t)r&&a.delete(String(r).split("#")[0]).catch(()=>{})}).catch(()=>{})}async function Ai(t,{shared:a=!1,lazyReleases:r=!1,lazyPlaylists:n=!1}={}){let s=a?we.store:_t(),o=a?we.storeFetcher:new Pr(s),l=new URL(t,window.location.href).href,u=(()=>{try{let m=$e(l);return{releases:m.releasesDoc.value,playlists:m.playlistsDoc.value}}catch{return{}}})(),p=u.releases||null,v=a&&qa();async function y(m){let b=String(m).split("#")[0];if(!(a&&we.isLoaded(b))){if(v){let g=await qs(b);if(g!=null)try{jt(g,s,b,"text/turtle"),we.markLoaded(b);return}catch{}}if(await o.load(b),a&&we.markLoaded(b),v)try{let g=we.serialize(R(b),s,b,"text/turtle");typeof g=="string"&&g.length&&await Hs(b,g)}catch{}}}try{await y(l);let m=8,b=new Set([l]),g=D=>{let I=[R(D),R(D.split("#")[0]+"#it")],F=D.split("#")[0],ce=r&&p&&F===p||n&&u.playlists&&F===u.playlists?[se("catalog"),se("themeTaxonomy")]:[lt("seeAlso"),se("dataset"),se("catalog"),se("themeTaxonomy")],ne=[];for(let xe of I)for(let ze of ce)for(let Ke of s.match(xe,ze,null))try{ne.push(new URL(Ke.object.value,D).href.split("#")[0])}catch{}return ne.filter(xe=>xe&&!b.has(xe)&&!/\.(meta|acl)$/i.test(xe))},f=g(l);for(;f.length;){let D=[];for(let I=0;I<f.length;I+=m){let F=f.slice(I,I+m).filter(B=>b.has(B)?!1:(b.add(B),!0));await Promise.all(F.map(async B=>{try{await y(B),D.push(...g(B))}catch(ce){console.warn("seeAlso load failed:",B,ce)}}))}f=D.filter(I=>!b.has(I))}return{store:s,baseURI:l,fetcher:o,loadDocs:async D=>{let I=[...new Set((D||[]).map(B=>B&&B.split("#")[0]))].filter(B=>B&&(a?!we.isLoaded(B):!b.has(B))),F=0;for(let B=0;B<I.length;B+=m){let ce=I.slice(B,B+m).filter(ne=>b.has(ne)?!1:(b.add(ne),!0));await Promise.all(ce.map(async ne=>{try{a&&we.isLoaded(ne)||(await o.load(ne),a&&we.markLoaded(ne)),F++}catch(xe){console.warn("lazy doc load failed:",ne,xe)}}))}return F}}}catch(m){throw console.error("Error loading RDF:",m),m}}async function $i(t,a){let r=_t(),n=async o=>{let l=await t(o,{headers:{Accept:"text/turtle"}});if(!l||l.ok===!1)throw new Error(`fetch ${o} \u2192 ${l&&l.status}`);let u=await l.text(),p=(l.headers?.get?.("Content-Type")||"text/turtle").split(";")[0].trim();jt(u,r,o.split("#")[0],p||"text/turtle")};await n(a);let s=r.any(R(a),Je("publicTypeIndex"))?.value||r.match(null,Je("publicTypeIndex"),null)[0]?.object?.value||null;if(!s)return{url:null,typeIndex:null,reason:"no solid:publicTypeIndex on profile"};await n(s);for(let o of r.match(null,Je("forClass"),J("Release"))){let l=r.any(o.subject,Je("instance"))?.value;if(l)return{url:l,typeIndex:s};let u=r.any(o.subject,Je("instanceContainer"))?.value;if(u)return{url:new URL("index.ttl",u).href,typeIndex:s}}return{url:null,typeIndex:s,reason:"no mo:Release TypeRegistration"}}async function jr(t,a){let r=_t(),n=await t(a,{headers:{Accept:"text/turtle"}});if(n&&n.ok!==!1){let u=(n.headers?.get?.("Content-Type")||"text/turtle").split(";")[0].trim();jt(await n.text(),r,a.split("#")[0],u||"text/turtle")}let s=Fe("http://www.w3.org/ns/pim/space#"),o=[],l=u=>{if(!u)return;let p=u.endsWith("/")?u:u+"/";o.includes(p)||o.push(p)};for(let u of r.match(R(a),s("storage"),null))l(u.object?.value);for(let u of r.match(null,s("storage"),null))l(u.object?.value);return l(new URL("/",a).href),o}async function ja(t,a,r){let n=await t(a,{method:"PATCH",headers:{"Content-Type":"application/sparql-update"},body:r});if(!n||n.ok===!1)throw new Error(`PATCH ${a} \u2192 ${n&&n.status}`)}async function Ti(t,a){let r="http://www.w3.org/ns/solid/terms#",n=Fe("http://www.w3.org/ns/pim/space#"),s=_t();try{let v=await t(a,{headers:{Accept:"text/turtle"}});if(v&&v.ok!==!1){let y=(v.headers?.get?.("Content-Type")||"text/turtle").split(";")[0].trim();jt(await v.text(),s,a.split("#")[0],y||"text/turtle")}}catch{}let o=s.any(R(a),Je("publicTypeIndex"))?.value||s.match(null,Je("publicTypeIndex"),null)[0]?.object?.value||null;if(o)return o;let l=s.any(R(a),n("storage"))?.value||s.match(null,n("storage"),null)[0]?.object?.value||new URL("/",a).href,u=l.endsWith("/")?l:l+"/",p=new URL("settings/publicTypeIndex.ttl",u).href;try{let v=await t(p,{method:"PUT",headers:{"Content-Type":"text/turtle"},body:`@prefix solid: <${r}>.
<${p}> a solid:TypeIndex, solid:ListedDocument.
`});return!v||v.ok===!1?null:(await ja(t,a.split("#")[0],`INSERT DATA { <${a}> <${r}publicTypeIndex> <${p}> . }`),p)}catch{return null}}function Ei(t,a){let r=String(a||"").replace(/[^A-Za-z0-9_-]/g,"-")||"lib";return`${t.split("#")[0]}#omp-lib-${r}`}async function Ci(t,a){let r=_t(),n=async u=>{let p=await t(u,{headers:{Accept:"text/turtle"}});if(!p||p.ok===!1)throw new Error(`fetch ${u} \u2192 ${p&&p.status}`);let v=(p.headers?.get?.("Content-Type")||"text/turtle").split(";")[0].trim();jt(await p.text(),r,u.split("#")[0],v||"text/turtle")};await n(a);let s=r.any(R(a),Je("publicTypeIndex"))?.value||r.match(null,Je("publicTypeIndex"),null)[0]?.object?.value||null;if(!s)return{typeIndex:null,libraries:[]};await n(s);let o=[],l=new Set;for(let u of r.match(null,Je("forClass"),J("Release"))){let p=r.any(u.subject,Je("instance"))?.value;if(!p||l.has(p))continue;l.add(p);let v=r.any(u.subject,lt("label"))?.value||r.any(u.subject,q("title"))?.value||"";o.push({url:p,label:v,reg:u.subject.value})}return{typeIndex:s,libraries:o}}async function Ha(t,a,{id:r,url:n,label:s}){if(!a||!n)throw new Error("registerPodLibrary: typeIndex and url required");let o="http://www.w3.org/ns/solid/terms#",l=Ei(a,r),u=(s||"").replace(/[\\"]/g,"\\$&");await ja(t,a,`DELETE { <${l}> ?p ?o } INSERT { <${l}> a <${o}TypeRegistration> ; <${o}forClass> <http://purl.org/ontology/mo/Release> ; <${o}instance> <${n}> ; <http://www.w3.org/2000/01/rdf-schema#label> "${u}" . } WHERE { OPTIONAL { <${l}> ?p ?o } }`)}async function Ii(t,a,{id:r,url:n}){if(!a)throw new Error("unregisterPodLibrary: typeIndex required");let s="http://www.w3.org/ns/solid/terms#",o=Ei(a,r);await ja(t,a,`DELETE { <${o}> ?p ?o } WHERE { <${o}> ?p ?o }`),n&&await ja(t,a,`DELETE { ?r ?p ?o } WHERE { ?r <${s}forClass> <http://purl.org/ontology/mo/Release> ; <${s}instance> <${n}> ; ?p ?o . }`)}function Br(t){return t+"#Favorites"}var Or=[Nr,J("MusicGroup"),J("SoloMusicArtist"),J("Label"),ye("Agent"),ye("Organization"),ye("Person"),ye("Group")],_i={audio:{nodeTypes:Or,nameProp:ye("name"),genreProp:J("genre")},video:{nodeTypes:[O("Collection")],nameProp:O("name"),genreProp:O("genre")}},Gs=t=>_i[t]||_i.audio;function Pi(t,a){let r=R(a.split("#")[0]+"#it"),n=t.any(r,q("type"))||t.any(R(a),q("type"));return n&&n.value===Fs("MovingImage").value?"video":"audio"}function Ks(t,a=Or){let r=new Set,n=[];for(let s of a)for(let o of t.match(null,oe("type"),s)){let l=o.subject.value;r.has(l)||(r.add(l),n.push(o.subject))}return n}function qr(t,a,r="audio"){let n=$e(a),s=Gs(r),o=R(a.split("#")[0]+"#it"),u=t.any(o,se("themeTaxonomy"))||t.any(R(a),se("themeTaxonomy"))||R(n.musicRootUri),p=t.match(null,st("topConceptOf"),u).map(y=>({id:y.subject.value,label:t.any(y.subject,st("prefLabel"))?.value||"Unnamed Genre"})),v=[];for(let y of Ks(t,s.nodeTypes)){let m=t.any(y,s.genreProp)?.value;if(!m)continue;let b=t.any(y,q("source"));v.push({node:y,label:t.any(y,s.nameProp)?.value||"Untitled",topic:m,url:t.any(y,se("landingPage"))?.value||null,source:null,sourcePlaylist:b?b.value:null,localData:!!b})}for(let y of t.match(null,oe("type"),Ot)){let m=y.subject,b=t.match(m,O("itemListElement"),null).map(g=>{let f=parseInt(t.any(g.object,O("position"))?.value,10);return{track:t.any(g.object,O("item")),pos:Number.isFinite(f)?f:Number.MAX_SAFE_INTEGER}}).filter(g=>g.track).sort((g,f)=>g.pos-f.pos);for(let{track:g}of b){let f=t.any(g,q("isPartOf"))||null,S=t.any(g,q("title"))?.value||"",D=f&&t.any(f,q("title"))?.value||"",I=t.any(g,ye("maker"))||(f?t.any(f,ye("maker")):null),F=I?I.termType==="Literal"?I.value:t.any(I,ye("name"))?.value||"":"",B=t.any(g,J("item"))?.value,ce=f&&t.any(f,se("landingPage"))?.value||null,ne=[F,D,S].filter(Boolean),xe=ne.length?ne.join(" \u2014 "):S||"Untitled";v.push({node:g,label:xe,topic:m.value,url:B||null,source:ce,artist:F,album:D,name:S})}}return{genres:p,bookmarks:v}}function Hr(t,a){let r=a?new URL("./",a).href:null,n=new Set,s=[];for(let o of t.match(null,oe("type"),Ot)){let l=o.subject;if(r&&!l.value.startsWith(r)||n.has(l.value))continue;n.add(l.value);let u=t.any(l,q("title"))?.value||t.any(l,lt("label"))?.value||l.value.replace(/^.*\//,"")||"Untitled playlist",p=t.any(l,ye("maker"))?.value||"",v=t.any(l,q("description"))?.value||"",y=t.any(l,Mr("styleClass")),m=t.match(null,q("source"),l)[0]?.subject;s.push({id:l.value,name:u,maker:p,description:v,hidden:y?y.value==="hidden":!1,artistNode:m||null,label:p?`${u} (${p})`:u})}return s}var At=!1;function Gr(t){At=!!t;try{console.info("[omp] setSolidWriteAuthed \u2192",At)}catch{}}try{typeof globalThis<"u"&&(globalThis.__OMP=globalThis.__OMP||{},globalThis.__OMP.writeAuthed=()=>At,globalThis.__OMP.isRdfStore=t=>t===we.store)}catch{}function Ws(t){if(t===we.store&&we.storeFetcher&&t.fetcher!==we.storeFetcher&&(t.fetcher=we.storeFetcher),!t.updater)try{new Li(t)}catch{}return t.updater}async function _e(t,a,r,n){r=r||[],n=n||[];try{console.info("[omp] runUpdate path:",t===we.store&&At?"pod-bypass":t===we.store?"UpdateManager (rdf.store but NOT authed-flag)":"UpdateManager (private store)","\xB7 isRdfStore="+(t===we.store)+" solidWriteAuthed="+At)}catch{}if(t===we.store&&At){let u=new Map,p=(y,m)=>{let b=y&&y.why&&y.why.value;b&&(u.has(b)||u.set(b,{del:[],ins:[]}),u.get(b)[m].push(y))};for(let y of r)p(y,"del");for(let y of n)p(y,"ins");if(!u.size)return{ok:!0,err:null};let v=y=>`${y.subject.toNT()} ${y.predicate.toNT()} ${y.object.toNT()} .`;for(let[y,m]of u){let b=[];m.del.length&&b.push(`DELETE DATA {
${m.del.map(v).join(`
`)}
...
`);try{let S=await za(y)(y,{method:"PATCH",headers:{"Content-Type":"application/sparql-update"},body:g});if(!S||S.ok===!1){let D=`PATCH ${y} \u2192 ${S&&S.status}`;return console.warn("Persistence failed (store NOT updated):",D),{ok:!1,err:D}}}catch(f){let S=f&&(f.message||String(f));return console.warn("Persistence failed (store NOT updated):",S),{ok:!1,err:S}}Rr(y);for(let f of m.del)t.remove(f);for(let f of m.ins)t.add(f.subject,f.predicate,f.object,f.why)}return{ok:!0,err:null}}let s=Ws(t);if(!s)return{ok:!1,err:"no UpdateManager available"};let o=()=>new Promise(u=>{try{s.update(r,n,(p,v,y)=>{u({ok:v,err:v?null:y})})}catch(p){u({ok:!1,err:p.message})}}),l=await o();if(!l.ok&&/uneditable|editing protocol|make changes/i.test(String(l.err))){let u=ua(t),p=new Set;for(let v of[...r,...n]){let y=v&&v.why;y&&y.value&&p.add(y.value)}for(let v of p)try{await u.load(v,{force:!0})}catch(y){console.warn("force-load failed",v,y?.message||y)}l=await o()}if(l.ok){let u=new Set;for(let p of[...r,...n]){let v=p&&p.why&&p.why.value;v&&u.add(v)}Rr(...u)}else console.warn("Persistence failed (store NOT updated):",l.err);return l}function ua(t){return t===we.store?we.storeFetcher:(t.fetcher||(t.fetcher=new Pr(t)),t.fetcher)}async function Di(t,a,r,{body:n,contentType:s}={}){try{let o;if(t===we.store&&At){let u={method:a};n!=null&&(u.body=n),s&&(u.headers={"Content-Type":s}),o=await za(r)(r,u)}else{let u=n!=null?{body:n,contentType:s}:{};o=await ua(t).webOperation(a,r,u)}let l=o.ok!==!1;return l&&Rr(r),{ok:l,err:l?null:`${a} ${o.status}`}}catch(o){return{ok:!1,err:o.message||String(o)}}}async function Ga(t,a,r,n="text/turtle"){return Di(t,"PUT",a,{body:r,contentType:n})}async function fa(t,a){return Di(t,"DELETE",a)}function Ge(t){return'"'+String(t).replace(/\\/g,"\\\\").replace(/"/g,'\\"')+'"'}async function Ui(t,{title:a="New library"}={}){let r=t.endsWith("/")?t:t+"/",n=_t(),s={"index.ttl":`@prefix dct: <http://purl.org/dc/terms/> .
...
`};for(let[o,l]of Object.entries(s)){let u=await Ga(n,r+o,l);if(!u.ok)return{ok:!1,err:`PUT ${o}: ${u.err}`,url:r+"index.ttl"}}return{ok:!0,url:r+"index.ttl"}}function Mi(t,a){let r=a?qt(a):null,n=new Set;for(let s of t.match(null,oe("type"),Ot)){let o=s.subject.value.split("#")[0];o&&o!==r&&n.add(o)}return[...n]}function Ka(t,a){let r=new Set((a||[]).map(s=>s.split("#")[0])),n=new Set;for(let s of t.match(null,O("item"),null)){let o=s.why&&s.why.value;if(!o||!r.has(o.split("#")[0]))continue;let l=s.object&&s.object.value;l&&n.add(l.split("#")[0])}return[...n]}function Ri(t,a){let r=$e(a),n=new Set;for(let s of t.match(r.releasesCatalog,se("dataset"),null))s.object?.value&&n.add(s.object.value.split("#")[0]);for(let s of t.match(r.releasesDoc,lt("seeAlso"),null))s.object?.value&&n.add(s.object.value.split("#")[0]);return[...n]}function Kr(t,a){let r=$e(a),n=new Set;for(let s of t.match(r.playlistsCatalog,se("dataset"),null))s.object?.value&&n.add(s.object.value.split("#")[0]);for(let s of t.match(r.playlistsDoc,lt("seeAlso"),null))s.object?.value&&n.add(s.object.value.split("#")[0]);return[...n]}async function Wr(t,a,r,n){let s=a.endsWith("/")?a:a+"/",o=0,l=0,u=[],p=0;for(let v of r){p++,n?.(p,r.length,v.relPath);let y=s+v.relPath;if(v.skipIfExists)try{let m=await t(y,{method:"HEAD"});if(m&&m.status===200){l++;continue}}catch{}try{let m=await t(y,{method:"PUT",headers:{"Content-Type":v.contentType||"text/turtle"},body:v.body}),b=!!m&&m.ok===!0,g=b?"2xx":"";if(!b&&m)try{let f=await t(y,{method:"GET",headers:{Accept:"*/*"}});b=!!f&&(f.ok===!0||f.status===304),g=`verified-get(${f?f.status:"no-resp"})`}catch(f){g=`verify-threw(${f.message||f})`}if(b)o++;else{let f="";try{f=(await m.text()).slice(0,120)}catch{}let S=`${v.relPath} \u2192 ${m?`${m.status} ${m.type||""}`:"no response"} [${g}] ${f}`.trim();u.push(S),console.warn("[install] PUT FAIL",S)}}catch(m){let b=`${v.relPath}: ${m.message||m}`;u.push(b),console.warn("[install] PUT THREW",b)}}return{ok:u.length===0,put:o,skipped:l,failed:u}}function Ba(t,a,r){return(t.statementsMatching(a,null,null)[0]||t.statementsMatching(null,null,a)[0])?.why||r}function Ni(t,a){if(!a)return null;for(let r of t.match(null,ye("name"),Q(a)))for(let n of Or)if(t.holds(r.subject,oe("type"),n))return r.subject;return null}async function Fi(t,a,r){let n=$e(a),s=n.genresDoc,o=Fr(r),l=s.value+"#"+o,u=1;for(;t.any(R(l),null,null);)l=s.value+"#"+o+"_"+u,u++;let p=R(l),v=R(n.musicRootUri),y=[P(p,oe("type"),st("Concept"),s),P(p,oe("type"),zs,s),P(p,st("prefLabel"),Q(r),s),P(p,st("topConceptOf"),v,s)];return{...await _e(t,s.value,[],y),id:l,label:r}}async function zi(t,a,r){let n=$e(a),s=n.genresDoc,o=n.agentsDoc,l=R(r),u=t.match(l,null,null).map(y=>P(y.subject,y.predicate,y.object,s)),p=await _e(t,s.value,u,[]);if(!p.ok)return p;let v=t.match(null,J("genre"),l).map(y=>y.subject);if(v.length){let y=[];for(let b of v)for(let g of t.match(b,null,null))y.push(P(g.subject,g.predicate,g.object,o));let m=await _e(t,o.value,y,[]);if(!m.ok)return m}return{ok:!0}}async function ji(t,a,r,n){let o=$e(a).genresDoc,l=R(r),u=t.any(l,st("prefLabel")),p=u?[P(l,st("prefLabel"),u,o)]:[],v=[P(l,st("prefLabel"),Q(n),o)];return _e(t,o.value,p,v)}async function Bi(t,a,r,n,s){let l=$e(a).agentsDoc,u=crypto.randomUUID?.()??`${Date.now()}-${Math.random().toString(36).slice(2)}`,p=R(`urn:uuid:${u}`),v=[P(p,oe("type"),Nr,l),P(p,ye("name"),Q(n),l),P(p,J("genre"),R(r),l)];return s&&v.push(P(p,se("landingPage"),R(s),l)),{...await _e(t,l.value,[],v),node:p}}async function Oi(t,a,r){let s=$e(a).agentsDoc,o=t.match(r,null,null).map(l=>P(l.subject,l.predicate,l.object,s));return _e(t,s.value,o,[])}async function Vr(t,a,r,n){let o=$e(a).agentsDoc,l=t.any(r,ye("name")),u=l?[P(r,ye("name"),l,o)]:[],p=[P(r,ye("name"),Q(n),o)];return _e(t,o.value,u,p)}async function Yr(t,a,r){typeof r=="string"&&(r={name:r});let{name:n="Untitled playlist",maker:s="",description:o=""}=r||{},l=$e(a),u=js(t,a,n),p=l.playlistsDirUrl+u,v=["@prefix dct: <http://purl.org/dc/terms/> .","@prefix dcat: <http://www.w3.org/ns/dcat#> .","@prefix foaf: <http://xmlns.com/foaf/0.1/> .","@prefix schema: <http://schema.org/> .","","<>","    a schema:ItemList, schema:MusicPlaylist, dcat:Dataset ;","    dct:isPartOf <../playlists.ttl#it> ;","    schema:itemListOrder schema:ItemListOrderAscending ;",`    dct:title ${Ge(n)}`];s&&v.push(`    ; foaf:maker ${Ge(s)}`),o&&v.push(`    ; dct:description ${Ge(o)}`),v.push("    .","");let y=v.join(`
`),m=s?`${n} (${s})`:n,b=await Ga(t,p,y);if(!b.ok)return{ok:!1,err:b.err,id:p,label:m};let g=P(l.playlistsCatalog,se("dataset"),R(p),l.playlistsDoc),f=await _e(t,l.playlistsDoc.value,[],[g]);if(!f.ok)return await fa(t,p),{...f,id:p,label:m};try{await ua(t).load(p,{force:!0})}catch(D){console.warn("Could not reload new playlist file for protocol detection:",D)}let S=R(p);return t.add(S,oe("type"),O("ItemList"),S),t.add(S,oe("type"),Ot,S),t.add(S,oe("type"),se("Dataset"),S),t.add(S,O("itemListOrder"),O("ItemListOrderAscending"),S),t.add(S,q("isPartOf"),l.playlistsCatalog,S),t.add(S,q("title"),Q(n),S),s&&t.add(S,ye("maker"),Q(s),S),o&&t.add(S,q("description"),Q(o),S),{ok:!0,id:p,label:m,name:n,maker:s,description:o}}function qt(t){return $e(t).playlistsDirUrl+"deleted"}async function Vs(t,a){let r=$e(a),n=qt(a),s=R(n);if(t.holds(s,oe("type"),Ot))return{ok:!0,id:n};let o=["@prefix dct: <http://purl.org/dc/terms/> .","@prefix dcat: <http://www.w3.org/ns/dcat#> .","@prefix schema: <http://schema.org/> .","","<>","    a schema:ItemList, schema:MusicPlaylist, dcat:Dataset ;","    dct:isPartOf <../playlists.ttl#it> ;","    schema:itemListOrder schema:ItemListOrderAscending ;",'    dct:title "Deleted" .',""].join(`
`),l=await Ga(t,n,o);if(!l.ok)return{ok:!1,err:l.err,id:n};let u=P(r.playlistsCatalog,se("dataset"),s,r.playlistsDoc),p=await _e(t,r.playlistsDoc.value,[],[u]);if(!p.ok)return await fa(t,n).catch(()=>{}),{...p,id:n};try{await ua(t).load(n,{force:!0})}catch(v){console.warn("Could not reload Deleted-bin file for protocol detection:",v)}return t.add(s,oe("type"),O("ItemList"),s),t.add(s,oe("type"),Ot,s),t.add(s,oe("type"),se("Dataset"),s),t.add(s,O("itemListOrder"),O("ItemListOrderAscending"),s),t.add(s,q("isPartOf"),r.playlistsCatalog,s),t.add(s,q("title"),Q("Deleted"),s),{ok:!0,id:n}}async function qi(t,a,r,n={}){let s=R(r),o=[],l=[];if(n.name!=null){for(let u of[q("title"),lt("label"),st("prefLabel")]){let p=t.any(s,u);p&&o.push(P(s,u,p,s))}l.push(P(s,q("title"),Q(n.name),s))}if(n.maker!=null){for(let u of t.match(s,ye("maker"),null))o.push(P(u.subject,u.predicate,u.object,s));n.maker&&l.push(P(s,ye("maker"),Q(n.maker),s))}if(n.description!=null){for(let u of t.match(s,q("description"),null))o.push(P(u.subject,u.predicate,u.object,s));n.description&&l.push(P(s,q("description"),Q(n.description),s))}return!o.length&&!l.length?{ok:!0}:_e(t,s.value,o,l)}async function Hi(t,a,r){let n=$e(a),s=R(r),o=qt(a);if(r!==o){let p=[];for(let v of t.match(s,O("itemListElement"),null)){let y=t.any(v.object,O("item"));if(!y)continue;let m=t.any(y,J("item"))?.value;if(!m)continue;let b=t.any(y,q("isPartOf"))||t.match(null,J("track"),y)[0]?.subject;p.push({url:m,source:b&&t.any(b,se("landingPage"))?.value||null,name:t.any(y,q("title"))?.value||"",album:b&&t.any(b,q("title"))?.value||""})}if(p.length){let v=await Vs(t,a);if(!v.ok)return v;let y=await Wa(t,a,o,p);if(!y.ok)return y}}let l=P(n.playlistsCatalog,se("dataset"),s,n.playlistsDoc),u=await _e(t,n.playlistsDoc.value,[l],[]);if(!u.ok)return u;await fa(t,r).catch(()=>{});for(let p of t.match(s,null,null))t.remove(p);for(let p of t.match(null,null,s))t.remove(p);return{ok:!0}}async function Wa(t,a,r,n,s={}){if(!n||!n.length)return{ok:!0,nodes:[],skipped:0};let o=$e(a),l=R(r),u=!!s.inlineTracks,p=L=>String(L).padStart(2,"0"),v=new Set;for(let L of t.match(l,O("itemListElement"),null)){let M=t.any(L.object,O("item")),K=M&&t.any(M,J("item"))?.value;K&&v.add(K)}let y=new Set,m=n.filter(L=>!L||!L.url||v.has(L.url)||y.has(L.url)?!1:(y.add(L.url),!0)),b=n.length-m.length;if(!m.length)return{ok:!0,nodes:[],added:[],skipped:b};if(u){let ue=function(Y,Te,je){if(!Y&&!Te)return null;if(Y&&K.has(Y))return K.get(Y);if(Y&&le.has(Y))return le.get(Y).node;M+=1;let Ee=R(`${l.value}#a${p(M)}`),We=[P(Ee,oe("type"),Bt,l)];return Te&&We.push(P(Ee,q("title"),Q(Te),l)),Y&&We.push(P(Ee,se("landingPage"),R(Y),l)),je&&We.push(P(Ee,ye("maker"),Q(je),l)),le.set(Y||`__nolp:${Ee.value}`,{node:Ee,inserts:We}),Ee},L=0,M=0,K=new Map,X=Y=>Y&&Y.value&&Y.value.startsWith(l.value+"#");for(let Y of t.match(l,O("itemListElement"),null)){let Te=t.any(Y.object,O("item"));if(X(Te)){let Ee=Te.value.match(/#t(\d+)$/);Ee&&(L=Math.max(L,parseInt(Ee[1],10)))}let je=Te&&t.any(Te,q("isPartOf"));if(X(je)){let Ee=je.value.match(/#a(\d+)$/);Ee&&(M=Math.max(M,parseInt(Ee[1],10)));let We=t.any(je,se("landingPage"))?.value;We&&K.set(We,je)}}let le=new Map,ve=0,ke=0;for(let Y of t.match(l,O("itemListElement"),null)){let Te=parseInt(t.any(Y.object,O("position"))?.value,10);Number.isFinite(Te)&&(ve=Math.max(ve,Te));let je=Y.object.value.match(/#e(\d+)$/);je&&(ke=Math.max(ke,parseInt(je[1],10)))}let he=[],re=[],mt=[];m.forEach((Y,Te)=>{let je=Y.album||"",Ee=Y.artist||"",We=Y.source||null,ha=ue(We,je,Ee);L+=1;let Xe=R(`${l.value}#t${p(L)}`);he.push(P(Xe,oe("type"),Dr,l)),Y.name&&he.push(P(Xe,q("title"),Q(Y.name),l)),Ee&&he.push(P(Xe,ye("maker"),Q(Ee),l)),he.push(P(Xe,J("item"),R(Y.url),l));let ht=Ur(Y.time);Number.isFinite(ht)&&ht>0&&he.push(P(Xe,J("duration"),Q(String(ht),void 0,ft("decimal")),l)),ha&&he.push(P(Xe,q("isPartOf"),ha,l));let Tt=R(`${l.value}#e${p(ke+Te+1)}`);he.push(P(l,O("itemListElement"),Tt,l),P(Tt,oe("type"),O("ListItem"),l),P(Tt,O("position"),Q(String(ve+Te+1),void 0,ft("integer")),l),P(Tt,O("item"),Xe,l)),re.push(Xe),mt.push(Y)});let tt=[];for(let Y of le.values())tt.push(...Y.inserts);let pa=[...tt,...he],ma=120;for(let Y=0;Y<pa.length;Y+=ma){let Te=await _e(t,l.value,[],pa.slice(Y,Y+ma));if(!Te.ok)return{...Te,nodes:re,added:mt,skipped:b}}return{ok:!0,nodes:re,added:mt,skipped:b}}let g=new Map;for(let L of t.match(null,se("landingPage"),null)){if(!t.holds(L.subject,oe("type"),Bt))continue;let M=Ba(t,L.subject,o.releasesDoc);g.set(L.object.value,{releaseNode:L.subject,fileDoc:R(M.value)})}let f=new Map;for(let[L,M]of g)for(let K of t.match(M.releaseNode,J("track"),null)){let X=t.any(K.object,J("item"))?.value;X&&f.set(`${L}
${X}`,K.object)}let S=new Set,D=(L,M)=>{let K=L&&L.match(/archive\.org\/details\/(.+?)\/?$/);return K?decodeURIComponent(K[1]):M.split("/").pop().replace(/\$?\.ttl$/,"")},I=new Map,F=L=>{let M=I.get(L.fileDoc.value);if(M==null){M=0;for(let K of t.match(L.releaseNode,J("track"),null)){let X=K.object.value.match(/#t(\d+)$/);X&&(M=Math.max(M,parseInt(X[1],10)))}}return M+=1,I.set(L.fileDoc.value,M),L.fileDoc.value+"#t"+p(M)},B=new Map,ce=new Map,ne=[],xe=[];for(let L of m){let M=L.source||null,K=L.url,X=M?`${M}
${K}`:null,le=X?f.get(X):null;if(!le&&M&&g.has(M)){let ue=g.get(M);le=R(F(ue));let ve=ce.get(ue.fileDoc.value)||{fileDoc:ue.fileDoc,inserts:[]};ve.inserts.push(P(le,oe("type"),Dr,ue.fileDoc)),L.name&&ve.inserts.push(P(le,q("title"),Q(L.name),ue.fileDoc)),ve.inserts.push(P(le,J("item"),R(K),ue.fileDoc));let ke=Ur(L.time);Number.isFinite(ke)&&ke>0&&ve.inserts.push(P(le,J("duration"),Q(String(ke),void 0,ft("decimal")),ue.fileDoc)),ve.inserts.push(P(le,q("isPartOf"),ue.releaseNode,ue.fileDoc)),ve.inserts.push(P(ue.releaseNode,J("track"),le,ue.fileDoc)),ce.set(ue.fileDoc.value,ve),X&&f.set(X,le)}if(!le){let ue=M||`urn:nolp:${K}`,ve=B.get(ue);if(!ve){let ke=Bs(t,o,L.album||L.name||"release",S);S.add(ke),ve={fileUrl:ke,lp:M,ident:D(M,ke),releaseNode:R(ke+"#it"),title:L.album||"(untitled album)",artist:L.artist||"",tracks:[]},B.set(ue,ve)}le=R(`${ve.fileUrl}#t${p(ve.tracks.length+1)}`),ve.tracks.push({node:le,name:L.name,dl:K,dur:Ur(L.time)}),X&&f.set(X,le)}ne.push(le),xe.push(L)}let ze=L=>({...L,nodes:ne,added:xe,skipped:b});for(let L of B.values()){let M=L.artist?Ni(t,L.artist):null,K=L.artist?M?`<${M.value}>`:Ge(L.artist):null,X=["a mo:Release, dcat:Dataset",`dct:title ${Ge(L.title)}`,`dct:identifier ${Ge(L.ident)}`,"dct:isPartOf <../releases.ttl#it>"];L.lp&&X.push(`dcat:landingPage <${L.lp}>`),X.push("mo:track "+L.tracks.map(re=>`<#t${p(L.tracks.indexOf(re)+1)}>`).join(", ")),K&&X.push(`foaf:maker ${K}`);let le=["@prefix dct: <http://purl.org/dc/terms/> .","@prefix mo: <http://purl.org/ontology/mo/> .","@prefix dcat: <http://www.w3.org/ns/dcat#> .","@prefix foaf: <http://xmlns.com/foaf/0.1/> .","",`<#it>
    `+X.join(` ;
...
`));if(!ue.ok)return ze(ue);let ve=[P(o.releasesCatalog,se("dataset"),L.releaseNode,o.releasesDoc)],ke=await _e(t,o.releasesDoc.value,[],ve);if(!ke.ok)return await fa(t,L.fileUrl).catch(()=>{}),ze(ke);try{await ua(t).load(L.fileUrl,{force:!0})}catch(re){console.warn("reload new release file failed:",re?.message||re)}let he=R(L.fileUrl);t.add(L.releaseNode,oe("type"),Bt,he),t.add(L.releaseNode,oe("type"),se("Dataset"),he),t.add(L.releaseNode,q("title"),Q(L.title),he),t.add(L.releaseNode,q("identifier"),Q(L.ident),he),t.add(L.releaseNode,q("isPartOf"),o.releasesCatalog,he),L.lp&&t.add(L.releaseNode,se("landingPage"),R(L.lp),he),L.artist&&t.add(L.releaseNode,ye("maker"),M||Q(L.artist),he);for(let re of L.tracks)t.add(re.node,oe("type"),Dr,he),re.name&&t.add(re.node,q("title"),Q(re.name),he),t.add(re.node,J("item"),R(re.dl),he),Number.isFinite(re.dur)&&re.dur>0&&t.add(re.node,J("duration"),Q(String(re.dur),void 0,ft("decimal")),he),t.add(re.node,q("isPartOf"),L.releaseNode,he),t.add(L.releaseNode,J("track"),re.node,he)}for(let L of ce.values()){let M=await _e(t,L.fileDoc.value,[],L.inserts);if(!M.ok)return ze(M)}let Ke=0,C=0;for(let L of t.match(l,O("itemListElement"),null)){let M=parseInt(t.any(L.object,O("position"))?.value,10);Number.isFinite(M)&&(Ke=Math.max(Ke,M));let K=L.object.value.match(/#e(\d+)$/);K&&(C=Math.max(C,parseInt(K[1],10)))}let G=[];ne.forEach((L,M)=>{let K=R(`${l.value}#e${p(C+M+1)}`);G.push(P(l,O("itemListElement"),K,l),P(K,oe("type"),O("ListItem"),l),P(K,O("position"),Q(String(Ke+M+1),void 0,ft("integer")),l),P(K,O("item"),L,l))});let Z=160;for(let L=0;L<G.length;L+=Z){let M=await _e(t,l.value,[],G.slice(L,L+Z));if(!M.ok)return ze(M)}return{ok:!0,nodes:ne,added:xe,skipped:b}}async function Gi(t,a,r,n){let s=R(r),o=[],l=null;for(let y of t.match(s,O("itemListElement"),null)){let m=y.object,b=t.any(m,O("item")),g=parseInt(t.any(m,O("position"))?.value,10);if((b&&t.any(b,J("item"))?.value)===n&&!l){l={ent:m,trk:b,pos:g};continue}o.push({ent:m,trk:b,pos:Number.isFinite(g)?g:Number.MAX_SAFE_INTEGER})}if(!l)return{ok:!0};let u=[P(s,O("itemListElement"),l.ent,s),P(l.ent,oe("type"),O("ListItem"),s),P(l.ent,O("position"),Q(String(l.pos),void 0,ft("integer")),s),P(l.ent,O("item"),l.trk,s)],p=[];o.sort((y,m)=>y.pos-m.pos).forEach((y,m)=>{let b=m+1;y.pos!==b&&(u.push(P(y.ent,O("position"),Q(String(y.pos),void 0,ft("integer")),s)),p.push(P(y.ent,O("position"),Q(String(b),void 0,ft("integer")),s)))});let v=await _e(t,s.value,u,p);if(!v.ok)return v;if(a&&r===qt(a))try{let y=$e(a),m=s,b=t.any(l.trk,q("isPartOf"))||t.match(null,J("track"),l.trk)[0]?.subject;if(b&&t.holds(b,oe("type"),Bt)){let g=t.match(b,J("track"),null).map(S=>S.object),f=!1;e:for(let S of g)for(let D of t.match(null,O("item"),S)){let I=t.match(null,O("itemListElement"),D.subject)[0]?.subject;if(I&&I.value!==m.value){f=!0;break e}}if(!f){let S=Ba(t,b,y.releasesDoc),D=[];for(let I of t.match(y.releasesCatalog,se("dataset"),b))D.push(P(I.subject,I.predicate,I.object,y.releasesDoc));for(let I of t.match(y.releasesDoc,lt("seeAlso"),null))I.object.value===S.value&&D.push(P(I.subject,I.predicate,I.object,y.releasesDoc));D.length&&await _e(t,y.releasesDoc.value,D,[]),await fa(t,S.value).catch(()=>{});for(let I of g){for(let F of t.match(I,null,null))t.remove(F);for(let F of t.match(null,null,I))t.remove(F)}for(let I of t.match(b,null,null))t.remove(I);for(let I of t.match(null,null,b))t.remove(I)}}}catch(y){console.warn("Deleted-bin release GC failed (orphan left for sweep):",y?.message||y)}return{ok:!0}}async function Ki(t,a,r,n={}){let s=$e(a),o=Ba(t,r,s.releasesDoc),l=[],u=[];if(n.title!=null){for(let p of t.match(r,q("title"),null))l.push(P(p.subject,p.predicate,p.object,o));n.title&&u.push(P(r,q("title"),Q(n.title),o))}if(n.artist!=null){for(let p of t.match(r,ye("maker"),null))l.push(P(p.subject,p.predicate,p.object,o));n.artist&&u.push(P(r,ye("maker"),Q(n.artist),o))}if(n.album!=null){let p=t.match(null,J("track"),r)[0]?.subject;if(p){let v=Ba(t,p,o);for(let y of t.match(p,q("title"),null))l.push(P(y.subject,y.predicate,y.object,v));n.album&&u.push(P(p,q("title"),Q(n.album),v))}}return!l.length&&!u.length?{ok:!0}:_e(t,o.value,l,u)}function Wi(t,a){let r=t.match(null,J("track"),a)[0]?.subject;if(!r)return 0;let n=t.match(r,J("track"),null).length;return Math.max(0,n-1)}function Jr(t,a){let r=[],n=new Set,s=l=>{t.holds(l,oe("type"),Bt)&&(n.has(l.value)||(n.add(l.value),r.push({name:t.any(l,q("title"))?.value||t.any(l,se("landingPage"))?.value||l.value,url:l.value,_local:!0,_releaseNode:l})))},o=t.any(a,q("source"));if(o){for(let l of t.match(o,O("itemListElement"),null)){let u=t.any(l.object,O("item")),p=u&&t.any(u,q("isPartOf"));p&&s(p)}return r}for(let l of t.match(null,ye("maker"),a))s(l.subject);return r}function Vi(t,a){let r=[];for(let n of t.match(a,J("track"),null)){let s=n.object,o=t.any(s,J("item"))?.value;if(!o)continue;let l=t.any(s,J("duration"))?.value;r.push({url:o,name:t.any(s,q("title"))?.value||s.value,time:Ys(l),node:s,_lengthSec:l!=null?parseFloat(l):NaN,_bitrate:NaN})}return r}function Ys(t){let a=parseFloat(t);if(!Number.isFinite(a)||a<=0)return"";let r=Math.floor(a/60),n=Math.floor(a%60);return`${r}:${String(n).padStart(2,"0")}`}async function Yi(t,a,r,n={}){let o=$e(a).agentsDoc,l=R(r),u=(n.name||t.any(l,q("title"))?.value||"Untitled Artist").trim(),p=n.genreId;if(!p)return{ok:!1,err:"a genre is required"};let v=new Set;for(let S of t.match(l,O("itemListElement"),null)){let D=t.any(S.object,O("item")),I=D&&t.any(D,q("isPartOf"));I&&t.holds(I,oe("type"),Bt)&&v.add(I.value)}let y=t.match(null,q("source"),l)[0]?.subject||Ni(t,u),m=y||R(`urn:uuid:${crypto.randomUUID?.()??`${Date.now()}-${Math.random().toString(36).slice(2)}`}`),b=y?t.statementsMatching(y,null,null).filter(S=>(S.why?.value||o.value)===o.value):[],g=[P(m,oe("type"),Nr,o),P(m,ye("name"),Q(u),o),P(m,J("genre"),R(p),o),P(m,q("source"),l,o)],f=await _e(t,o.value,b,g);return f.ok?{ok:!0,node:m,name:u,genreId:p,albumCount:v.size,relinked:!!y}:{...f,node:null}}async function Xr(t,a,r){let s=$e(a).agentsDoc,o=R(r),l=t.match(null,q("source"),o)[0]?.subject;if(!l)return{ok:!0,node:null};let u=t.statementsMatching(l,null,null).filter(v=>(v.why?.value||s.value)===s.value),p=await _e(t,s.value,u,[]);return p.ok?(await Qr(t,a,r,!1).catch(()=>{}),{ok:!0,node:l}):{...p,node:l}}async function Qr(t,a,r,n){let s=R(r),o=t.statementsMatching(s,Mr("styleClass"),null),l=n?[P(s,Mr("styleClass"),Q("hidden"),s)]:[];return!o.length&&!l.length?{ok:!0}:_e(t,s.value,o,l)}function Ur(t){if(!t)return NaN;let a=String(t).trim();if(!a)return NaN;if(/^[0-9.]+$/.test(a))return parseFloat(a);let r=a.split(":").map(Number);return r.some(n=>!Number.isFinite(n))?NaN:r.length===3?r[0]*3600+r[1]*60+r[2]:r.length===2?r[0]*60+r[1]:r[0]}function Ji(t){let a=String(t).trim();if(!a)return null;let r=a.match(/archive\.org\/details\/([^\/?\s#]+)/);return r?{id:r[1],url:`https://archive.org/details/${r[1]}`}:/^[a-zA-Z0-9._-]+$/.test(a)?{id:a,url:`https://archive.org/details/${a}`}:null}var rc=(()=>{try{return/[?&](code|state)=/.test(location.search)}catch{return!1}})();function Js({libraryConfigs:t,libs:a,host:r}){let n=()=>yt()[0]?.mediaType||"audio",s=r?.getAttribute?.("storage-ns")||"",o=s?":"+s:"",l=!!s,u=!!r?.hasAttribute?.("favourites-only"),p=()=>n()==="video"?"MovingImage":"Sound",v=new Set,y=[],m=Wn({mediaType:n(),panel:l}),{container:b,audio:g,status:f,trackCount:S,nowPlaying:D,filmIntro:I,filmIntroTitle:F,filmIntroLength:B,filmIntroAbout:ce,filmIntroRights:ne,prevBtn:xe,playBtn:ze,nextBtn:Ke,seekSlider:C,timeCur:G,timeDur:Z,volumeSlider:L,sourcesList:M,favouritesList:K,librariesList:X,genreList:le,artistList:ue,albumList:ve,trackTable:ke,trackHead:he,trackBody:re,trackEmpty:mt,randomizeBtn:tt,clearTracksBtn:pa,helpMenuItem:ma,helpLinkMenuItem:Y,loginHelpMenuItem:Te,filtersMenuItem:je,savePlaylistMenuItem:Ee,installPodMenuItem:We,updateAppMenuItem:ha,viewDeletedMenuItem:Xe,addPlaylistBtn:ht,addSourceBtn:Tt,addGenreBtn:Xa,addArtistBtn:Qa,genreColumnFooter:Ht,artistColumnFooter:Gt,themeToggle:Kt,fontSizeBtn:ba,setMenuOpen:at}=m,Et=document.documentElement,ga=()=>document.querySelector("sol-default");function Za(){return Et.getAttribute("data-theme")||ga()?.getAttribute("theme")||(matchMedia("(prefers-color-scheme: light)").matches?"light":"dark")}function er(){return Et.getAttribute("data-fontsize")||ga()?.getAttribute("fontsize")||"medium"}function on(){let e=Za()!=="light";if(Kt){Kt.setAttribute("aria-checked",e?"true":"false");let c=Kt.querySelector(".gear-theme-ico"),d=Kt.querySelector(".gear-theme-label");c&&(c.textContent=e?"\u{1F319}":"\u2600\uFE0F"),d&&(d.textContent=e?"Dark mode":"Light mode")}let i=er();if(ba){let c=ba.querySelector(".gear-fontsize-label");c&&(c.textContent="Text size: "+i[0].toUpperCase()+i.slice(1));let d=ba.querySelector(".gear-fontsize-ico");d&&(d.style.fontSize=i==="small"?"0.8rem":i==="large"?"1.2rem":"1rem")}}let tr=["small","medium","large"];function io(e){Et.setAttribute("data-theme",e);try{localStorage.setItem("omp:theme",e)}catch{}document.dispatchEvent(new CustomEvent("omp:appearance"))}function oo(e){Et.setAttribute("data-fontsize",e);try{localStorage.setItem("omp:fontsize",e)}catch{}document.dispatchEvent(new CustomEvent("omp:appearance"))}ga()?.hasAttribute("theme")||Et.setAttribute("data-theme",Za()),ga()?.hasAttribute("fontsize")||Et.setAttribute("data-fontsize",er()),Kt?.addEventListener("click",()=>io(Za()==="light"?"dark":"light")),ba?.addEventListener("click",()=>{oo(tr[(tr.indexOf(er())+1)%tr.length])}),document.addEventListener("omp:appearance",on),on();function so(){try{return!!document.querySelector("sol-default")?.hasAttribute("solid-kitchen")}catch{return!1}}function Wt(){return document.querySelector("sol-login")}function ya(){let e=Wt();return!!(e&&e.isLoggedIn)}function rt(){return ya()||so()}function va(){let e=!rt();b.classList.toggle("guest-mode",e);let i=ya(),c=i&&Wt()?.webId||"",d=b.querySelector(".manage-btn");d&&(d.classList.toggle("logged-in",i),d.title=c||"Menu");try{r?.dispatchEvent(new CustomEvent("omp:access",{detail:{guest:e,real:i,webId:c}}))}catch{}}function ar(e,i){return e.map(c=>({...c,_lib:i.config.id}))}let bt=[],te=[],Me=[],Ie=new Set,gt=new Set;function yt(){return a.filter(e=>e.store&&t.find(i=>i.id===e.config.id)?.enabled)}function nt(){let e=yt();bt=e.flatMap(i=>ar(i.genres,i)),te=e.flatMap(i=>ar(i.bookmarks,i)),Me=e.flatMap(i=>ar(i.playlists,i)),Ie=new Set(Me.map(i=>i.id)),gt=new Set(e.map(i=>Br(i.baseURI)))}function rr(e=n()){return e==="video"?{genre:"Film Types",artist:"Collections",album:"Movies",addGenre:"+ Add film type",addArtist:"+ Add collection",allGenre:"(All film types)",allArtist:"(All collections)",allAlbum:"(All movies)",find:"Find a film\u2026",chooseArtist:"Choose a collection to see films.",loadingAlbums:"Loading films\u2026",noAlbums:"No films found."}:{genre:"Genres",artist:"Artists",album:"Albums",addGenre:"+ Add genre",addArtist:"+ Add artist",allGenre:"(All genres)",allArtist:"(All artists)",allAlbum:"(All albums)",find:"Find artist\u2026",chooseArtist:"Choose an artist to see albums.",loadingAlbums:"Loading albums\u2026",noAlbums:"No albums found."}}function sn(){let e=n();b.classList.toggle("media-video",e==="video"),b.classList.toggle("media-audio",e!=="video");let i=rr(e);for(let x of["genre","artist","album"]){let k=b.querySelector(`[data-column="${x}"] .ia-column-header`);k&&(k.textContent=i[x])}Xa&&(Xa.textContent=i.addGenre),Qa&&(Qa.textContent=i.addArtist),ot.setAllLabel(i.allGenre),Ze.setAllLabel(i.allArtist),be.setAllLabel(i.allAlbum);let c=b.querySelector(".ia-artist-search-input");c&&(c.placeholder=i.find);let d=b.querySelector(".ia-artist-search"),h=b.querySelector(".ia-nowplaying"),w=b.querySelector(".ia-toolbar");d&&(e==="video"&&h&&d.parentElement!==h?h.appendChild(d):e!=="video"&&w&&d.parentElement===h&&w.appendChild(d)),Ze.getSelection().size===0&&!et&&U==="library"&&be.setMessage(i.chooseArtist),b.classList.toggle("has-video",e==="video"&&Yt)}function Qe(e){if(!e?.store)return;let i=qr(e.store,e.baseURI,e.mediaType);e.genres=i.genres,e.bookmarks=i.bookmarks,e.playlists=Hr(e.store,e.baseURI),nt()}async function wa(e,i){if(!e?.store||typeof e.loadDocs!="function"||!i?.length)return!1;let c=0;try{c=await e.loadDocs(i)}catch(d){console.warn("[lazy] release load failed:",d?.message||d)}return c&&Qe(e),c>0}function lo(e,i){return e?.store?Ka(e.store,[String(i).split("#")[0]]):[]}function Be(){return yt()[0]||null}function xa(e){return a.find(i=>i.config.id===e)||null}let Ve=null,vt=!1,ct=!1,Ct=!1,Ye=null;function nr(){nt(),Oe(),ge(),De(),Pe(),dt(),U="library",ut("library")}function ln(){nt(),Oe(),ge(),De(),Pe(),dt(),ut(U)}async function co(e){for(let d=a.length-1;d>=0;d--)a[d].config.solid&&a.splice(d,1);for(let d=t.length-1;d>=0;d--)t[d].solid&&t.splice(d,1);Ve||(Ve=t.map(d=>[d.id,d.enabled])),t.forEach(d=>{d.enabled=!1});let i={id:"solid",label:"My Pod",url:e,enabled:!0,solid:!0};t.push(i);let c=await pt(i);if(!c.store){let d=t.indexOf(i);if(d>=0&&t.splice(d,1),Ve){for(let[h,w]of Ve){let x=t.find(k=>k.id===h);x&&(x.enabled=w)}Ve=null}for(let h of t){if(h.solid||!h.enabled||a.some(k=>k.config.id===h.id&&k.store))continue;let w=await pt(h),x=a.findIndex(k=>k.config.id===h.id);x>=0?a[x]=w:a.push(w)}return vt=!1,ct=!1,nr(),{ok:!1,err:c.error}}a.push(c);try{let d=new URL(e,location.href).href,h=w=>w&&!w.solid&&w.url&&(()=>{try{return new URL(w.url,location.href).href===d}catch{return!1}})();for(let w=a.length-1;w>=0;w--)h(a[w].config)&&a.splice(w,1);for(let w=t.length-1;w>=0;w--)h(t[w])&&t.splice(w,1);Ve&&(Ve=Ve.filter(([w])=>t.some(x=>x.id===w)))}catch(d){console.warn("[pod] self-hosted dedupe skipped:",d?.message||d)}return vt=!!(Ce&&Ce.isLoggedIn),ct=!vt,Ct=!1,nr(),{ok:!0,authed:vt}}function sl(){to();for(let e=a.length-1;e>=0;e--)a[e].config.solid&&a.splice(e,1);for(let e=t.length-1;e>=0;e--)t[e].solid&&t.splice(e,1);if(Ve){for(let[e,i]of Ve){let c=t.find(d=>d.id===e);c&&(c.enabled=i)}Ve=null}else t.forEach(e=>{e.enabled=!0});vt=!1,ct=!1,Ct=!1,nr()}let It="random",Vt="off",uo=!1,ir=!1,U="library",Pt=[];nt();let cn="ia-player:state"+o;s&&b.classList.add("panel-instance"),t.length===1&&b.classList.add("single-library");let wt=null,or=!1;function fo(){try{let e=localStorage.getItem(cn);return e?JSON.parse(e):null}catch(e){return console.warn("Could not read saved state:",e),null}}function dn(e){try{localStorage.setItem(cn,JSON.stringify(e))}catch(i){console.warn("Could not write state:",i)}}let un=new Set(["title","artist","album"]);function po(){let e={};return ke&&ke.querySelectorAll("col").forEach(i=>{i.style.width&&!un.has(i.dataset.col)&&(e[i.dataset.col]=i.style.width)}),e}function mo(e){if(!(!e||!ke))for(let[i,c]of Object.entries(e)){if(un.has(i))continue;let d=ke.querySelector(`col[data-col="${CSS.escape(i)}"]`);d&&(d.style.width=c)}}function fn(){let e=na?.getSort?.()??{col:null,dir:"asc"};return{shuffle:It==="random",repeat:Vt,volume:g.volume,source:U,genreSel:[...ot.getSelection()],artistSel:[...Ze.getSelection()],albumSel:[...be.getSelection()],sortCol:e.col,sortDir:e.dir,columnWidths:po(),sourcesWidth:b.style.getPropertyValue("--ia-sources-width")||"",browserHeight:b.style.getPropertyValue("--ia-browser-height")||"",libraryTracks:ie.map(i=>({id:i.id,url:i.url,name:i.name,artist:i.artist||"",album:i.album||"",albumUrl:i.albumUrl||"",time:i.time||"",_lib:i._lib})),currentTrackUrl:Se?.url||null,currentTime:Se&&g.src===Se.url&&Number.isFinite(g.currentTime)?g.currentTime:0}}function Ae(){or||(wt&&clearTimeout(wt),wt=setTimeout(()=>{wt=null,dn(fn())},400))}function ho(){wt&&(clearTimeout(wt),wt=null),dn(fn())}window.addEventListener("beforeunload",ho);async function bo(){let e=fo();if(e){or=!0;try{typeof e.volume=="number"&&(g.volume=Math.min(1,Math.max(0,e.volume)),L.value=String(g.volume)),wr(e.shuffle?"random":"ordered"),Dn(e.repeat||"off"),mo(e.columnWidths),e.sourcesWidth&&b.style.setProperty("--ia-sources-width",e.sourcesWidth),e.browserHeight&&b.style.setProperty("--ia-browser-height",e.browserHeight),e.sortCol&&na.setSort&&na.setSort(e.sortCol,e.sortDir),Array.isArray(e.genreSel)&&e.genreSel.length&&ot.setSelection(e.genreSel,{notify:!1}),ge(),Array.isArray(e.artistSel)&&e.artistSel.length&&Ze.setSelection(e.artistSel,{notify:!1});let i=new Set(t.filter(d=>d.enabled).map(d=>d.id));Array.isArray(e.libraryTracks)&&e.libraryTracks.length&&(ie=e.libraryTracks.map(d=>({...d})).filter(d=>!d._lib||i.has(d._lib)));let c=e.source&&e.source!=="library"&&Ie.has(e.source);if(e.source==="favorites"?(U="favorites",it.setSelection(["favorites"],{notify:!1}),b.classList.add("source-favorites"),En(),Ta()):c?(U=e.source,it.setSelection([e.source],{notify:!1}),ta(e.source)):(e.source&&e.source!=="library"&&e.source!=="favorites"&&(Jt=e.source),U="library",N=ie,qe=kt(),fe()),Qt(),c||(await De(),Array.isArray(e.albumSel)&&e.albumSel.length&&be.setSelection(e.albumSel,{notify:!1})),e.currentTrackUrl){let d=ie.find(h=>h.url===e.currentTrackUrl)||N.find(h=>h.url===e.currentTrackUrl);if(d&&(!d._lib||i.has(d._lib))){Se=d,Yt=n()==="video",b.classList.toggle("has-video",Yt),Ma(D,Pn(d)),fe(),g.src=d.url;let h=Number.isFinite(e.currentTime)&&e.currentTime>0?e.currentTime:0;if(h>0){let w=()=>{g.removeEventListener("loadedmetadata",w);try{g.currentTime=h}catch{}};g.addEventListener("loadedmetadata",w)}g.load()}}}finally{or=!1}}}let N=[],ie=[],Dt=null,ka=!1,Se=null,Yt=!1,Jt=null,xt=new Map,Ut=new Map;function Sa(e){e&&xt.delete(e)}function sr(e){let i=Me.find(c=>c.id===e);i?.artistNode&&Sa(i.artistNode.value)}let pn="omp-player:quality-filter"+o,La={minTrackDurationSec:180,minTrackBitrateKbps:0,minItemRuntimeSec:0,minDownloads:0,blockedCollections:[],applyToCatalogArtists:!1};function go(){try{let e=localStorage.getItem(pn);if(!e)return{...La};let i=JSON.parse(e);return{...La,...i}}catch{return{...La}}}function yo(e){try{localStorage.setItem(pn,JSON.stringify(e))}catch(i){console.warn("Could not persist filter:",i)}}let Mt=go();function lr(e){return e[Math.floor(Math.random()*e.length)]}function vo(e){return e?.match(/(?:\/details\/|archive\.org\/details\/)([^/?]+)/)?.[1]??null}function Rt(e){return e.node?.value||e.url}function Xt(e,i){return e.label.localeCompare(i.label,void 0,{sensitivity:"base"})}function wo(e){return/\b40[13]\b|unauthor|forbidden|not allowed|permission|credential/i.test(String(e||""))}function cr(){let e=Wt();if(!e)return!1;if(!l)try{at(!0)}catch{}try{e.scrollIntoView?.({block:"nearest",inline:"nearest"});let i=e.shadowRoot&&e.shadowRoot.querySelector(".auth-btn");if(i)return i.click(),!0;if(typeof e._handleClick=="function")return e._handleClick(),!0;if(e.issuers&&e.issuers[0])return e.login(e.issuers[0]),!0}catch{}return!1}function xo(e){if(!ct)return!1;let i=!!(Ce&&Ce.isLoggedIn);return $(f,i?`"${e}" not saved \u2014 your pod denied the write (no permission). Changes stay in this browser only.`:`"${e}" not saved \u2014 log in to save to your pod. Changes stay in this browser only.`),Ct||i||(Ct=!0,confirm(`Couldn't save "${e}" to your pod.
...
Cancel = keep working in this browser (changes won't be saved)`)&&(cr()||$(f,'Open the gear menu and click "Log in" to sign in to your pod.'))),!0}function Ue(e,i){if(e&&e.ok)return!0;let c=e?.err||"persistence failed";return console.warn(`checkSaved: ${i}:`,e),ct&&wo(c)?xo(i):$(f,`Couldn't ${i}: ${c}. No changes saved.`),!1}function _a(e){return`<button type="button" class="ia-src-edit ia-row-kebab" data-action="edit" aria-label="Edit ${H(e)}" aria-haspopup="menu" title="Edit" tabindex="-1">\u22EF</button>`}function mn(e,i,{onCommit:c}){if(!e)return;let d=e.innerHTML;e.innerHTML=`<input type="text" class="ia-row-rename" value="${H(i)}" aria-label="Rename" spellcheck="false">`;let h=e.querySelector("input");h.focus(),h.select();let w=!1,x=()=>{e.innerHTML=d},k=()=>{if(w)return;w=!0;let A=h.value.trim();A&&A!==i?c(A):x()},T=()=>{w||(w=!0,x())};h.addEventListener("keydown",A=>{A.stopPropagation(),A.key==="Enter"?(A.preventDefault(),k()):A.key==="Escape"&&(A.preventDefault(),T())}),h.addEventListener("click",A=>A.stopPropagation()),h.addEventListener("dblclick",A=>A.stopPropagation()),h.addEventListener("mousedown",A=>A.stopPropagation()),h.addEventListener("blur",k)}let hn=Lt(X,{onChange:e=>So(e),showAll:!1,multiSelect:!1,allowDeselect:!1,renderItemActions:e=>_a(e.label),onItemAction:(e,i,c)=>{e==="edit"&&Eo(i,c)}}),it=Lt(M,{onChange:e=>ut([...e][0]||"library"),showAll:!1,multiSelect:!1,allowDeselect:!0,renderItemActions:e=>_a(e.label),onItemAction:(e,i,c)=>{e==="edit"&&vn(i,c)},onItemDrop:(e,i)=>Mo(e,i)}),bn=Lt(K,{onChange:e=>{let i=[...e][0];if(!i)return;let c=y.find(d=>(d.item||d.link)===i);c&&ko(c)},showAll:!1,multiSelect:!1,allowDeselect:!0,renderItemActions:()=>rt()?'<button type="button" class="ia-row-favdel" data-action="favdel" title="Remove from the communal favourites" aria-label="Remove favourite" tabindex="-1">\u2715</button>':"",onItemAction:(e,i)=>{e==="favdel"&&confirm("Remove this favourite from the communal wall?")&&Ca(i)}});function gn(){let e=y.map(i=>({id:i.item||i.link,label:i.canonicalTitle||"Untitled",title:i.contributors?.length?`Favourited by ${i.contributors.map(c=>c.name).join(", ")}`:"",_fav:i})).sort((i,c)=>i.label.localeCompare(c.label,void 0,{sensitivity:"base"}));bn.setItems(e),bn.setMessage(e.length?null:n()==="video"?"No favourite films yet \u2014 tap \u2606 on a film.":"No favourites yet \u2014 tap \u2606 on a track.")}function ko(e){let i=e.link||e.item,c=e.canonicalTitle||"Untitled";if(n()==="video"){Sn({url:i,name:c});return}He({id:i,url:i,name:c,album:"Community Favorites",albumUrl:"",time:"",artist:""})}function dt(){let e=c=>c==="video"?"\u{1F3AC}":"\u{1F3B5}";hn.setItems(t.map(c=>{let d=a.find(w=>w.config.id===c.id),h=d&&d.mediaType||c.mediaType||"audio";return{id:c.id,label:`${e(h)} ${c.label}`}}));let i=t.filter(c=>c.enabled).map(c=>c.id);hn.setSelection(i,{notify:!1})}dt();function Pe(){let e=Me.filter(i=>!i.hidden&&!i.id.endsWith("/playlists/deleted")).map(i=>({id:i.id,label:i.label,title:i.description||""}));it.setItems(e),e.some(i=>i.id===U)?it.setSelection([U],{notify:!1}):(U==="favorites"&&(U="library"),it.setSelection([],{notify:!1})),Qt()}function Qt(){b.classList.toggle("viewing-playlist",Ie.has(U)),b.classList.toggle("viewing-library",U==="library")}Pe(),gn(),u&&(b.classList.add("favourites-only"),ht&&(ht.hidden=!0));function Nt(){if(!s){nn(t);for(let e of t)e.url&&!e.solid&&Zs(e.url,e.enabled)}}async function So(e){t.forEach(i=>{i.enabled=e.has(i.id)}),Nt();for(let i of t){if(!i.enabled)continue;let c=a.findIndex(d=>d.config.id===i.id);c>=0&&a[c].unloaded&&($(f,`Loading "${i.label}"\u2026`),a[c]=await pt(i),$(f,a[c].error?`Could not load "${i.label}": ${a[c].error}`:`Loaded "${i.label}".`))}nt(),sn(),U!=="library"&&U!=="favorites"&&!Ie.has(U)&&(U="library"),ot.setSelection([],{notify:!1}),Ze.setSelection([],{notify:!1}),be.setSelection([],{notify:!1}),N=ie,Oe(),ge(),De(),Pe(),U==="library"?(N=ie,qe=kt(),fe()):U==="favorites"?Tn():ta(U)}async function dr(e){if(!(!Ye||!Ye.typeIndex||!e||e.solid||!e.url))try{await Ha(Ye.authedFetch,Ye.typeIndex,{id:e.id,url:new URL(e.url,location.href).href,label:e.label})}catch(i){console.warn("type-index register failed (kept locally):",i?.message||i)}}async function Lo(e){if(!(!Ye||!Ye.typeIndex||!e))try{await Ii(Ye.authedFetch,Ye.typeIndex,{id:e.id,url:e.url?new URL(e.url,location.href).href:null})}catch(i){console.warn("type-index unregister failed:",i?.message||i)}}async function ll(e,i){let c;try{c=await Ci(e,i)}catch(k){console.warn("listRegisteredLibraries failed:",k?.message||k);return}let d=c.typeIndex;if(Ye=d?{authedFetch:e,webId:i,typeIndex:d}:null,!d)return;let h=new Set(c.libraries.map(k=>k.url));for(let k of t){if(k.solid||!k.url)continue;let T=new URL(k.url,location.href).href;if(!h.has(T))try{await Ha(e,d,{id:k.id,url:T,label:k.label})}catch(A){console.warn("push register failed:",A?.message||A)}}let w=new Set(t.filter(k=>k.url).map(k=>new URL(k.url,location.href).href)),x=!1;for(let k of c.libraries){if(w.has(k.url))continue;let T={id:Xi(),label:k.label||k.url,url:k.url,enabled:ro(k.url,!1)},A=await pt(T);if(A.error){console.warn("discovered library failed to load:",k.url,A.error);continue}a.push(A),t.push(T),x=!0}x&&(Nt(),nt(),dt(),Pe(),Oe(),ge(),De(),U==="library"&&(N=ie,fe()))}async function yn(e,i){let d={id:Xi(),label:e,url:i,enabled:!0};$(f,`Loading "${e}"\u2026`);let h=await pt(d);if(h.error){$(f,`Could not load "${e}": ${h.error}`);return}a.push(h),t.push(d),Nt(),nt(),dt(),Pe(),Oe(),ge(),De(),await dr(d),$(f,Ye?`Added "${e}" (registered on your pod).`:`Added "${e}".`)}async function _o(e){let i=t.find(T=>!T.solid&&$t(T.url)),d=new URL(i?i.url:"./libraries/_/index.ttl",location.href).href.match(/^(.*\/libraries\/)/)?.[1];if(!d){$(f,"Could not locate the libraries/ root.");return}let h=new Set(t.map(T=>(T.url||"").match(/\/libraries\/([^/]+)\//)?.[1]).filter(Boolean)),w=Qi(e);for(let T=2;h.has(w);T++)w=`${Qi(e)}_${T}`;let x=d+w+"/";$(f,`Creating library "${e}"\u2026`);let k=await Ui(x,{title:e});if(!k.ok){$(f,`Couldn't create "${e}": ${k.err}`);return}await yn(e,k.url)}function Ao(e,i){let c=t.find(d=>d.id===e);c&&(c.label=i,Nt(),dt(),dr(c))}async function $o(e,i){let c=t.find(w=>w.id===e);if(!c)return;c.url=i,Nt(),$(f,`Reloading "${c.label}" from ${i}\u2026`);let d=await pt(c),h=a.findIndex(w=>w.config.id===e);h>=0?a[h]=d:a.push(d),nt(),dt(),Pe(),Oe(),ge(),De(),U==="library"&&(N=ie,fe()),await dr(c),d.error?$(f,`Could not load: ${d.error}`):$(f,`Reloaded "${c.label}".`)}function To(e){let i=t.findIndex(h=>h.id===e);if(i<0)return;let c=t[i];Lo(c),t.splice(i,1);let d=a.findIndex(h=>h.config.id===e);d>=0&&a.splice(d,1),Nt(),ie=ie.filter(h=>h._lib!==e),nt(),dt(),Pe(),Oe(),ge(),De(),U==="library"&&(N=ie,fe())}function Eo(e,i){let c=t.find(d=>d.id===e);c&&ri({title:"Edit library",values:{label:c.label,url:c.url},canDelete:t.length>1,onSave:async({label:d,url:h})=>{d!==c.label&&Ao(e,d),h!==c.url&&await $o(e,h)},onDelete:()=>{if(!confirm(`Delete library "${c.label}"?
Its contents stay on disk; only this player will forget about it.`))return!1;To(e)}})}function vn(e,i){if(!Ie.has(e))return;let c=Me.find(_=>_.id===e);if(!c)return;let d=Ft(e);if(!d)return;function h(_,E,z){for(let ae=te.length-1;ae>=0;ae--)te[ae].node&&te[ae].node.value===_.value&&te.splice(ae,1);te.push({node:_,label:E,topic:z,url:null,source:null,localData:!0,sourcePlaylist:e,_lib:d.config.id})}async function w(){let _=bt.filter(j=>!gt.has(j.id));if(!_.length){$(f,"Add a genre first \u2014 a converted artist needs one.");return}let E=(prompt("Artist name:",c.name)||"").trim();if(!E)return;let z=_.slice().sort(Xt),ae=prompt(`Genre? Enter a number:
`+z.map((j,pe)=>`  ${pe+1}. ${j.label}`).join(`
`),"1");if(ae==null)return;let V=z[parseInt(ae,10)-1];if(!V){$(f,"Conversion cancelled \u2014 no valid genre picked.");return}let ee=await Yi(d.store,d.baseURI,e,{name:E,genreId:V.id});Ue(ee,`convert "${c.name}" to an artist`)&&(c.artistNode=ee.node,h(ee.node,E,V.id),Sa(ee.node.value),ge(),De(),$(f,`${ee.relinked?"Relinked":"Converted"} "${c.name}" \u2192 artist "${E}" (${ee.albumCount} album${ee.albumCount===1?"":"s"}). Playlist kept.`))}async function x(){if(!confirm(`Unlink the artist from "${c.name}"?
The playlist and its tracks stay; it just stops also appearing as an artist.`))return!1;let _=await Xr(d.store,d.baseURI,e);if(Ue(_,`unlink artist from "${c.name}"`)){if(_.node){for(let E=te.length-1;E>=0;E--)te[E].node&&te[E].node.value===_.node.value&&te.splice(E,1);Sa(_.node.value)}c.artistNode=null,c.hidden=!1,ge(),De(),Pe(),$(f,`Unlinked artist from "${c.name}". Playlist kept.`)}}async function k(){if(!confirm(`Delete playlist "${c.name}"?`))return!1;let _=await Hi(d.store,d.baseURI,e);if(!Ue(_,`delete playlist "${c.name}"`))return;for(let z=te.length-1;z>=0;z--)te[z].topic===e&&te.splice(z,1);let E=Me.findIndex(z=>z.id===e);E>=0&&Me.splice(E,1),Ie.delete(e),U===e&&(U="library",ut("library")),Pe()}let A=!rt()?[]:[c.artistNode?{label:"Unlink artist",onClick:x}:{label:"Convert to artist\u2026",onClick:w},{label:"Remove playlist",danger:!0,onClick:k}];Lr({title:"Edit playlist",values:{name:c.name,maker:c.maker,description:c.description},actions:A,onSave:async({name:_,maker:E,description:z})=>{let ae=await qi(d.store,d.baseURI,e,{name:_,maker:E,description:z});if(!Ue(ae,`edit playlist "${c.name}"`))return;if(c.artistNode&&_&&_!==c.name){let ee=await Vr(d.store,d.baseURI,c.artistNode,_);if(!Ue(ee,`update linked artist "${c.name}" \u2192 "${_}"`))return}let V=E?`${_} (${E})`:_;Qe(d),Pe(),ge(),$(f,`Updated "${V}".`)}})}function Co(e){return le.querySelector(`.ia-listbox-item[data-id="${CSS.escape(e)}"]`)}function Io(e){return ue.querySelector(`.ia-listbox-item[data-id="${CSS.escape(e)}"]`)}function Po(e){return te.find(i=>Rt(i)===e)}function Do(e,i){let c=bt.find(d=>d.id===e);c&&la(i,[{id:"rename",label:"Rename"},{id:"delete",label:"Delete"}],async d=>{let h=Fo(e);if(h){if(d==="rename")mn(Co(e),c.label,{onCommit:async w=>{let x=await ji(h.store,h.baseURI,e,w);if(!Ue(x,`rename genre "${c.label}"`)){Oe();return}Qe(h),Oe(),ge()}});else if(d==="delete"){let w=te.filter(T=>T.topic===e&&Aa(T)).length,x=w?`Delete genre "${c.label}" and its ${w} artist${w===1?"":"s"}?`:`Delete genre "${c.label}"?`;if(!confirm(x))return;let k=await zi(h.store,h.baseURI,e);if(!Ue(k,`delete genre "${c.label}"`))return;Qe(h),Oe(),ge(),De()}}})}function Uo(e,i){let c=Po(e);if(!c)return;if(c.sourcePlaylist&&Ie.has(c.sourcePlaylist)){let w=c.sourcePlaylist,x=Me.find(_=>_.id===w),k=Ft(w),T=fr(c),A=[{id:"edit",label:"Edit playlist\u2026"},{id:"toggle-hide",label:x?.hidden?"Show in Playlists":"Hide from Playlists"},{id:"unlink",label:"Unlink artist"},{id:"visit-ia",label:"Visit on the Internet Archive"}];la(i,A,async _=>{if(_==="visit-ia"){window.open(T,"_blank","noopener");return}if(_==="edit"){vn(w);return}if(k){if(_==="toggle-hide"){let E=!x?.hidden,z=await Qr(k.store,k.baseURI,w,E);if(!Ue(z,`${E?"hide":"show"} playlist "${x?.name||""}"`))return;x&&(x.hidden=E),E&&U===w&&(U="library",ut("library")),Pe(),$(f,E?`"${x?.name}" hidden from Playlists (still an artist).`:`"${x?.name}" shows in Playlists again.`)}else if(_==="unlink"){if(!confirm(`Unlink the artist from "${x?.name}"?
The playlist and its tracks stay; it just stops appearing as an artist.`))return;let E=await Xr(k.store,k.baseURI,w);if(!Ue(E,`unlink artist from "${x?.name||""}"`))return;let z=te.indexOf(c);z>=0&&te.splice(z,1),E.node&&Sa(E.node.value),x&&(x.artistNode=null,x.hidden=!1),ge(),De(),Pe(),$(f,`Unlinked artist from "${x?.name}". Playlist kept.`)}}});return}let d=fr(c);la(i,[{id:"rename",label:"Rename"},{id:"delete",label:"Delete"},{id:"visit-ia",label:"Visit on the Internet Archive"}],async w=>{if(w==="visit-ia"){window.open(d,"_blank","noopener");return}let x=$a(c);if(x){if(w==="rename")mn(Io(e),c.label,{onCommit:async k=>{let T=await Vr(x.store,x.baseURI,c.node,k);if(!Ue(T,`rename artist "${c.label}"`)){ge();return}Qe(x),ge()}});else if(w==="delete"){if(!confirm(`Delete artist "${c.label}"?`))return;let k=await Oi(x.store,x.baseURI,c.node);if(!Ue(k,`delete artist "${c.label}"`))return;Qe(x),ge(),De()}}})}function wn(){if(Ht.querySelector(".ia-column-addform"))return;Ht.innerHTML=`
    ...
    `;let e=Ht.querySelector("form"),i=e.querySelector("input"),c=()=>xn();i.focus(),e.addEventListener("submit",async d=>{d.preventDefault();let h=i.value.trim();if(!h){c();return}let w=Be();if(!w){$(f,"Enable a library first."),c();return}let x=await Fi(w.store,w.baseURI,h);xn(),Ue(x,`add genre "${h}"`)&&(bt.push({id:x.id,label:h,_lib:w.config.id}),Oe())}),e.querySelector(".ia-column-addcancel").addEventListener("click",c),i.addEventListener("keydown",d=>{d.key==="Escape"&&c()})}function xn(){Ht.innerHTML='<button type="button" class="ia-add-genre-btn">+ Add genre</button>',Ht.querySelector(".ia-add-genre-btn").addEventListener("click",wn)}Xa.addEventListener("click",wn);function kn(){if(Gt.querySelector(".ia-column-addform"))return;let e=bt.filter(k=>!gt.has(k.id));if(!e.length){$(f,"Add a genre first.");return}let i=e.slice().sort(Xt).map(k=>`<option value="${H(k.id)}">${H(k.label)}</option>`).join("");Gt.innerHTML=`
    ...
    `;let c=Gt.querySelector("form"),d=c.querySelector("input"),h=c.querySelector("select"),w=[...ot.getSelection()];w.length===1&&e.some(k=>k.id===w[0])&&(h.value=w[0]);let x=()=>ur();d.focus(),c.addEventListener("submit",async k=>{k.preventDefault();let T=d.value.trim();if(!T){x();return}let A=Ji(T),_;if(A)_=A.url;else try{_=new URL(T).href}catch{$(f,`Not a valid URL: "${T}". Enter a full http(s) URL or an archive.org item id.`),d.focus(),d.select();return}let E=A?A.id:(prompt("Display name for this artist:","")||"").trim();if(!E){x();return}let z=h.value,ae=Be();if(!ae){$(f,"Enable a library first."),x();return}let V;try{V=await Bi(ae.store,ae.baseURI,z,E,_)}catch(ee){ur(),$(f,`Couldn't add artist "${E}": ${ee.message||ee}`);return}ur(),Ue(V,`add artist "${E}"`)&&(te.push({node:V.node,label:E,topic:z,url:_,source:null,_lib:ae.config.id}),ge())}),c.querySelector(".ia-column-addcancel").addEventListener("click",x),d.addEventListener("keydown",k=>{k.key==="Escape"&&x()})}function ur(){Gt.innerHTML='<button type="button" class="ia-add-artist-btn">+ Add artist</button>',Gt.querySelector(".ia-add-artist-btn").addEventListener("click",kn)}Qa.addEventListener("click",kn),Tt.addEventListener("click",async()=>{let e=prompt(`Add a library:

  1 = create a new empty library
  2 = add an existing one by URL`,"1");if(e!=null)if(e.trim()==="1"){let i=prompt("New library name:");if(!i||!i.trim())return;await _o(i.trim())}else{let i=prompt("Library RDF URL (its index.ttl):");if(!i||!i.trim())return;let c=i.trim().split("/").filter(Boolean).pop()||"Library",d=prompt("Display name:",c);if(!d||!d.trim())return;await yn(d.trim(),i.trim())}});async function Mo(e,i){if(!Ie.has(e))return;let c=i.getData("application/x-ia-tracks");if(!c)return;let d;try{d=JSON.parse(c)}catch{return}if(!Array.isArray(d)||!d.length)return;let h=d.map(E=>N.find(z=>z.id===E)).filter(Boolean);if(!h.length)return;let w=Ft(e);if(!w)return;$(f,`Adding ${h.length} track${h.length===1?"":"s"} to playlist\u2026`);let x=h.map(E=>({label:[E.artist,E.album,E.name].filter(Boolean).join(" \u2014 ")||E.name,url:E.url,source:E.albumUrl,artist:E.artist,album:E.album,name:E.name,time:E.time})),k=!rt(),T=await Wa(w.store,w.baseURI,e,x,{inlineTracks:k}),A=T.added||[];A.forEach((E,z)=>{te.push({node:T.nodes?.[z],label:E.label,topic:e,url:E.url,source:E.source,_lib:w.config.id})});let _=T.skipped||0;if(T.ok)A.length?$(f,`Added ${A.length} track${A.length===1?"":"s"}`+(_?` (${_} already in playlist)`:"")+"."):$(f,_?`All ${_} track${_===1?"":"s"} already in this playlist.`:"Nothing to add.");else{let E=T.err||"persistence failed";$(f,A.length?`Saved ${A.length} track${A.length===1?"":"s"}, then the server failed: ${E}. Retry to add the rest.`:`Couldn't add tracks to playlist: ${E}. No changes saved.`),console.warn("add tracks to playlist (partial/failed):",T)}A.length&&sr(e),U===e&&ta(e)}ht.addEventListener("click",()=>{if(!rt()){$(f,"Sign in to create playlists.");return}let e=Be();if(!e){$(f,"Enable a library to add playlists.");return}Lr({title:"New playlist",values:{name:`Playlist ${Me.length+1}`,maker:"jeffz",description:""},onSave:async({name:i,maker:c,description:d})=>{let h=await Yr(e.store,e.baseURI,{name:i,maker:c,description:d});Ue(h,`add playlist "${i}"`)&&(Me.push({id:h.id,name:h.name,maker:h.maker,description:h.description,label:h.label,_lib:e.config.id}),Ie.add(h.id),Pe(),$(f,`Added playlist "${h.label}". Drag tracks onto it to fill it.`))}})});function ut(e){U=e,Dt=null,ka=!1,b.classList.remove("source-no-browser"),b.classList.remove("source-favorites"),e==="library"?(N=ie,qe=kt(),fe()):e==="favorites"?(b.classList.add("source-favorites"),Tn()):Ie.has(e)?(ta(e),$(f,"Tip: select tracks (Shift/Ctrl-click) and press Delete to remove them.")):(U="library",Pe(),N=ie,fe()),Qt(),Ae()}let ot=Lt(le,{onChange:Go,allLabel:"(All genres)",renderItemActions:e=>gt.has(e.id)?"":_a(e.label),onItemAction:(e,i,c)=>{e==="edit"&&Do(i,c)}});function fr(e){let i=e.url||"";if(/(?:^|\/\/)(?:www\.)?archive\.org\//.test(i))return i;let c=`${e.label||""} AND mediatype:${n()==="video"?"movies":"audio"}`;return`https://archive.org/search?query=${encodeURIComponent(c)}`}function Ro(e){let i=fr(e),c="Visit on the Internet Archive",d=`<button type="button" class="ia-row-ialink" data-action="ialink" data-url="${H(i)}" title="${c}" aria-label="${c}" tabindex="-1">\u2197</button>`;return _a(e.label)+d}let Ze=Lt(ue,{onChange:Ko,allLabel:"(All artists)",renderItemActions:Ro,onItemAction:(e,i,c)=>{if(e==="edit")Uo(i,c);else if(e==="ialink"){let d=c?.dataset?.url;d&&window.open(d,"_blank","noopener")}}}),be=Lt(ve,{onChange:Wo,allLabel:"(All albums)",renderItemActions:e=>{if(n()!=="video")return"";let i=!!e._album&&v.has(e._album.url);return`<button type="button" class="ia-row-fav${i?" on":""}" data-action="fav" title="Add to the communal favourites" aria-label="Favourite" tabindex="-1">${i?"\u2605":"\u2606"}</button>`},onItemAction:(e,i)=>{e==="fav"&&Bo(i)}});function Oe(){let e=bt.filter(i=>!gt.has(i.id)).map(i=>({id:i.id,label:i.label,title:i.label})).sort(Xt);ot.setItems(e)}function Aa(e){return!gt.has(e.topic)&&!Ie.has(e.topic)}function No(e){return gt.has(e.topic)}function Fo(e){let i=bt.find(c=>c.id===e);return i?xa(i._lib):Be()}function $a(e){return e._lib?xa(e._lib):Be()}function Ft(e){let i=Me.find(c=>c.id===e);return i?xa(i._lib):Be()}function zo(e){let i=te.find(c=>No(c)&&c.url===e);return i?xa(i._lib):Be()}async function Ta(){try{y=(await Fa()).filter(i=>i.bucket===p()),v=new Set(y.flatMap(i=>[i.item,i.link].filter(Boolean)))}catch{}try{fe(),jo(),gn()}catch{}}function jo(){n()==="video"&&be.setItems(be.getItems())}function Bo(e){let c=be.getItems().find(d=>d.id===e)?._album;if(c){if(v.has(c.url)){Ca(c.url);return}r?.dispatchEvent(new CustomEvent("item-favourite",{detail:{item:c.url,bucket:"MovingImage",schemaType:"VideoObject",name:c.name||c.url,link:c.url,download:!1,thumbnail:c.thumbnail||""},bubbles:!0,composed:!0}))}}async function Sn(e){let i=e.url||"";if(/\/download\//.test(i)||/\.(mp4|m4v|ogv|ogg|webm|mov|mkv|avi|mpe?g)(\?|#|$)/i.test(i)){let w={id:i,url:i,name:e.name||i,time:"",artist:"",album:e.name||"",albumUrl:""};He(w,{autoplay:!1}),hr(w,{name:e.name});return}let d={url:i,name:e.name};$(f,"Loading film\u2026");let h=null;try{h=Cn(await Zt(d))}catch{}if(!h){$(f,""),ra(`Can't play \u201C${e.name}\u201D \u2014 no playable video found at the Internet Archive.`);return}$(f,""),He(h,{autoplay:!1}),hr(h,d)}function Oo(e){if(!e||!e.url)return;if(Ea(e.url)){Ca(e.url);return}let i=n()==="video";r?.dispatchEvent(new CustomEvent("item-favourite",{detail:{item:e.url,bucket:i?"MovingImage":"Sound",schemaType:i?"VideoObject":"AudioObject",name:e.name||e.url,link:e.url,download:!0},bubbles:!0,composed:!0}))}function Ea(e){return v.has(e)}async function Ca(e){let i=y.find(d=>d.item===e||d.link===e);if(!i)return!1;let c=0;for(let d of i.contributors||[])if(d.file)try{await da(d.file),c++}catch(h){$(f,`Couldn't remove favourite: ${h.message}`)}return c&&document.dispatchEvent(new CustomEvent("omp:favourited")),c>0}function pr(){let e=ot.getSelection();return e.size===0?te.filter(Aa):te.filter(i=>e.has(i.topic)&&Aa(i))}function mr(e){if(!e)return!1;if(e.sourcePlaylist)return!0;let i=d=>(d||"").trim().toLowerCase(),c=i(e.label);for(let d of Me)if(d.name&&i(d.name)===c||d.maker&&i(d.maker)===c)return!0;if(e.localData&&e.node){let d=$a(e);try{return!!d?.store&&Jr(d.store,e.node).length>0}catch{return!1}}return!1}function ge(){let i=pr().map(w=>({id:Rt(w),label:w.label,title:w.label,url:w.url,_b:w})),c=i.filter(w=>mr(w._b)).sort(Xt),d=i.filter(w=>!mr(w._b)).sort(Xt),h=n()==="video";d.forEach((w,x)=>{w.className="ia-item-raw",w.ariaLabel=`${w.label} \u2014 raw archive.org search, not curated`,x===0&&!h&&(w.section="Raw \u2014 uncurated archive.org searches")}),Ze.setItems([...c,...d])}async function Ln(e){let i=Rt(e);if(xt.has(i))return xt.get(i);if(e.localData&&e.node){let h=$a(e);if(h?.store){let w=(async()=>{let x=e.sourcePlaylist?Ka(h.store,[String(e.sourcePlaylist).split("#")[0]]):Ri(h.store,h.baseURI);return await wa(h,x)&&ge(),Jr(h.store,e.node).map(T=>({...T,_artist:e}))})();return xt.set(i,w),w}}let c=Cr(e.url);if(!c){let h=Promise.resolve([]);return xt.set(i,h),h}let d=Ir(c,Mt,{mediaType:n()}).then(h=>h.map(w=>({...w,_artist:e}))).catch(h=>(console.error("getAlbums",h),[]));return xt.set(i,d),d}let Ia=0,et=null;function qo(){return ve.closest(".ia-column")}function Pa(e){let i=qo();if(!i)return;let c=i.querySelector(".ia-album-note");if(!e){c?.remove();return}c||(c=document.createElement("div"),c.className="ia-album-note",i.querySelector(".ia-column-header")?.after(c)),c.textContent=e}function _n(){et&&(et=null,Pa(""))}function An(){be.setItems(et.map(e=>{let i=n()==="video"?e.name:`${e._artist.label} \u2014 ${e.name}`;return{id:e.url,label:i,title:i,_album:e}}))}async function De(){if(U==="favorites")return;if(et){An(),St();return}let e=rr(),i=Ze.getSelection();if(i.size===0){be.setMessage(e.chooseArtist),St();return}let c=++Ia;be.setMessage(e.loadingAlbums);let h=pr().filter(k=>i.has(Rt(k))),w=await Promise.all(h.map(Ln));if(c!==Ia)return;let x=w.flat();if(!x.length){be.setMessage(e.noAlbums),St();return}be.setItems(x.map(k=>{let T=n()==="video"?k.name:`${k._artist.label} \u2014 ${k.name}`;return{id:k.url,label:T,title:T,_album:k}})),(Dt||ka)&&n()!=="video"&&be.setSelection(x.map(k=>k.url),{notify:!1}),St()}async function Zt(e){let i=e.url;if(Ut.has(i))return Ut.get(i);if(e._local&&e._releaseNode){let A=$a(e._artist);if(A?.store){let _=String(e._releaseNode.value||e._releaseNode).split("#")[0],E=(async()=>(await wa(A,[_]),Vi(A.store,e._releaseNode).map(z=>({id:z.url,url:z.url,name:z.name,time:z.time||"",artist:e._artist?.label||"",album:e.name,albumUrl:e.url,node:z.node||null,_lib:e._artist?._lib}))))();return Ut.set(i,E),E}}let c=vo(e.url);if(!c)return Promise.resolve([]);let d=Array.isArray(e._creator)?e._creator[0]:e._creator,h=d?String(d).trim():"",x=/^(various(\s+artists?)?|v\.?a\.?)$/i.test(h)?"":h,k=e._artist?.label||"",T=Si(c,Mt,{mediaType:n()}).then(A=>(A||[]).map(_=>({id:_.url,url:_.url,name:_.name,time:_.time||"",artist:_.artist||x||k,album:e.name,albumUrl:e.url,_lib:e._artist?._lib,_rights:_._rights||e._rights||null,_detailUrl:_._detailUrl||e._detailUrl||e.url||""}))).catch(A=>(console.error("getTracks",A),[]));return Ut.set(i,T),T}let $n=0,qe="Choose an album to add tracks.";function kt(){return Ze.getSelection().size===0?"Choose an artist to see albums.":be.getSelection().size===0?"Choose an album to add tracks.":"No tracks in selected album(s)."}async function St(){if(U!=="library"||n()==="video")return;let e=be.getSelection();if(!e.size){N=ie,qe=kt(),fe();return}let i=++$n;ie.length||(qe="Loading tracks\u2026",N=ie,fe());let d=be.getItems().filter(k=>e.has(k.id)).map(k=>k._album),h=await Promise.all(d.map(Zt));if(i!==$n)return;let w=new Set(ie.map(k=>k.id)),x=h.flat().filter(k=>!w.has(k.id));x.length&&(ie=ie.concat(x),Ae()),N=ie,qe=kt(),oa(),fe()}function Tn(){if(n()==="video"){br(),b.classList.remove("has-video");try{g.pause()}catch{}}En(),Ta()}function En(){let e=new Map(ie.map(i=>[i.url,i]));N=y.map(i=>{let c=i.item||i.link,d=e.get(c)||i.link&&e.get(i.link)||i.item&&e.get(i.item);return d||{id:c,url:i.link||i.item,name:i.canonicalTitle||"Untitled",time:"",artist:"",album:"Favorites",albumUrl:"",thumbnail:i.thumbnail||""}}),qe=u?"No favourite films yet \u2014 tap \u2606 on a film to add one.":"No favourites yet \u2014 tap \u2606 on a track to add one.",oa(),fe()}function Ho(e){let i=e.name||"",c=e.artist||"",d=e.album||"";if(!i&&!c&&!d){let h=(e.label||"").split(" \u2014 ");h.length>=3?(c=h[0],d=h[1],i=h.slice(2).join(" \u2014 ")):h.length===2?(d=h[0],i=h[1]):i=e.label||""}return{id:e.url,url:e.url,name:i||e.label,artist:c,album:d,albumUrl:e.source||"",time:"",node:e.node||null,_lib:e._lib}}let ea=0;function ta(e){let i=++ea,c=Ft(e);if(c?.loadDocs){let d=lo(c,e),h=te.some(w=>w.topic===e&&w.url);if(d.length&&!h){N=[],qe="Loading playlist\u2026",fe(),wa(c,d).then(()=>{i!==ea||U!==e||(Da(e,i),ge())}).catch(()=>{i===ea&&U===e&&Da(e,i)});return}d.length&&wa(c,d).then(w=>{w&&i===ea&&U===e&&Da(e,i)}).catch(()=>{})}Da(e,i)}function Da(e,i){N=te.filter(h=>h.topic===e).map(Ho),qe="This playlist is empty.",oa(),fe();let d=new Map;for(let h of N)h.albumUrl&&(d.has(h.albumUrl)||d.set(h.albumUrl,[]),d.get(h.albumUrl).push(h));for(let[h,w]of d){let x={url:h,name:w[0].album||"",_artist:{label:w[0].artist||""}};Zt(x).then(k=>{if(i!==ea)return;let T=new Map(k.map(_=>[_.url,_])),A=!1;for(let _ of w){let E=T.get(_.url);E&&(E.time&&!_.time&&(_.time=E.time,A=!0),E.name&&_.name!==E.name&&(_.name=E.name,A=!0))}A&&U===e&&(oa(),fe())}).catch(()=>{})}}function fe(){let e=U==="favorites",i=rt();if(Xn(re,mt,N,{currentTrackId:Se?.id,isFav:c=>Ea(c.url),favouritable:!0,wallDelete:e&&i,emptyMessage:qe,useKebab:c=>e||!c.node?!1:Nn(c)?!0:!!(c.albumUrl&&/(?:^|\/\/)(?:www\.)?archive\.org\//.test(c.albumUrl))}),Rn?.applySelection(),S){let c=N.length;if(!c)S.textContent="";else{let d=0;for(let T of N)d+=ia(T.time);let h=Math.round(d/60),w=Math.floor(h/60),x=h%60,k=d>0?w>0?` \xB7 ${w}h ${String(x).padStart(2,"0")}m`:` \xB7 ${x}m`:"";S.textContent=`${c} track${c===1?"":"s"}${k}`}}}function aa(){return U==="library"?!1:(U="library",it.setSelection([],{notify:!1}),Qt(),!0)}function Go(e){aa(),_n(),ge(),De(),Ae()}function Ko(e){if(aa(),_n(),Dt=null,ka=!1,e&&e.size===1){let i=pr().filter(c=>e.has(Rt(c)));i.length===1&&(ka=mr(i[0]),i[0].sourcePlaylist&&(Dt=i[0].sourcePlaylist))}De(),Ae()}function Wo(e){if(n()==="video"){Vo(e);return}aa()&&(ie=[]),St(),Ae()}function Cn(e){if(!e||!e.length)return null;let i=e[0],c=ia(i.time);for(let d of e){let h=ia(d.time);h>c&&(i=d,c=h)}return i}let In=0;async function Vo(e){aa();let i=[...e],c=i[i.length-1];if(!c){N=[],fe(),Ae();return}be.setSelection([c],{notify:!1});let h=be.getItems().find(T=>T.id===c)?._album;if(!h)return;let w=++In;$(f,"Loading film\u2026");let x=await Zt(h);if(w!==In)return;let k=Cn(x);if(!k){$(f,""),ra(`Can't play \u201C${h.name}\u201D \u2014 no playable video found at the Internet Archive.`);return}N=[k],$(f,""),He(k,{autoplay:!1}),hr(k,h),Ae()}let Yo=null;function hr(e,i){if(!I)return;F.textContent=i?.name||e.album||e.name||"Untitled",B.textContent=e.time?`Running time: ${e.time}`:"";let c=e.albumUrl||i?.url||"";if(ce.innerHTML=c?`See more about this film at the <a href="${H(c)}" target="_blank" rel="noopener">Internet Archive</a>`:"",ne){let d=e._rights||i?._rights||null;ne.textContent=`\u2696 ${d?d.label:"Rights unknown"}`}Yo={track:e,album:i},b.classList.add("film-intro")}function br(){b.classList.remove("film-intro")}if(I){let e=()=>{br(),g.play().catch(()=>{})};I.addEventListener("click",e),I.addEventListener("keydown",i=>{(i.key==="Enter"||i.key===" ")&&(i.preventDefault(),e())}),g.addEventListener("play",br)}function Jo(){Se&&(Pt.push({track:Se}),Pt.length>200&&Pt.shift())}let gr=null;function ra(e,i={}){let c=b.querySelector(".ia-notice");c||(c=document.createElement("div"),c.className="ia-notice",c.setAttribute("role","alert"),c.innerHTML='<span class="ia-notice-icon" aria-hidden="true">\u26A0</span><span class="ia-notice-msg"></span><button type="button" class="ia-notice-close" aria-label="Dismiss">\u2715</button>',c.querySelector(".ia-notice-close").addEventListener("click",()=>yr()),b.appendChild(c)),c.querySelector(".ia-notice-msg").textContent=e,c.classList.add("show"),clearTimeout(gr),i.sticky||(gr=setTimeout(yr,i.duration||4e3))}function yr(){clearTimeout(gr),b.querySelector(".ia-notice")?.classList.remove("show")}function He(e,i={}){if(!e)return;yr();let c=i.autoplay!==!1;Se&&Se.id!==e.id&&!i.fromHistory&&Jo(),Se=e,c&&(uo=!0),g.src=e.url,g.load(),Yt=n()==="video",b.classList.toggle("has-video",Yt),Ma(D,Pn(e)),$(f,""),Ae(),fe(),c&&g.play().catch(d=>{if(d.name==="NotAllowedError"||d.name==="AbortError"){console.warn("Playback deferred:",d.name),$(f,"Press \u25B6 to start playback");return}$(f,`Error playing ${e.name}`),ra(`Can't play \u201C${e.name}\u201D. The media may be unavailable or in an unsupported format.`),console.error("Playback error:",d)})}function Pn(e){let i=e.albumUrl?` <a class="ia-link" href="${H(e.albumUrl)}" target="_blank" rel="noopener">[IA]</a>`:"",c=e._rights?` \xB7 <span class="ia-np-rights">\u2696 ${H(e._rights.label)}</span>`:"";if(n()==="video")return`Now playing: ${H(e.album||e.name||"Untitled")}${c}${i}`;let d=[e.artist,e.album,e.name].filter(Boolean).map(H),h=N.findIndex(x=>x.id===e.id),w=h>=0&&N.length>1?` (${h+1}/${N.length})`:"";return`Now playing: ${d.join(" \u2014 ")}${w}${c}${i}`}async function Ua(){let e=te.filter(i=>Aa(i)&&i.url);if(!(!e.length||ir)){ir=!0;try{for(let i=0;i<6;i++){let c=lr(e),d=await Ln(c);if(!d.length)continue;let h=lr(d),w=await Zt(h);if(!w.length)continue;let x=lr(w);U!=="library"&&(it.setSelection(["library"],{notify:!1}),ut("library")),ot.setSelection([c.topic],{notify:!1}),ge(),Ze.setSelection([Rt(c)],{notify:!1}),await De(),be.setSelection([h.url],{notify:!1}),await St(),He(x);return}$(f,"Could not find a random track to play")}finally{ir=!1}}}function Xo(){return Se?N.findIndex(e=>e.id===Se.id):-1}function vr(){if(It==="random"){Ua();return}if(Vt==="one"&&Se){g.currentTime=0,g.play().catch(()=>{});return}let e=Xo();if(e<0){N[0]&&He(N[0]);return}if(e+1<N.length){He(N[e+1]);return}if(Vt==="all"&&N[0]){He(N[0]);return}$(f,"Reached the end of the list")}function Qo(){if(!Pt.length){$(f,"No previous track");return}let e=Pt.pop();He(e.track,{fromHistory:!0})}function wr(e){It=e,Ae()}function Dn(e){Vt=e,Ae()}Yn(ke),ke.addEventListener("mouseup",()=>Ae());let Un=b.querySelector(".ia-sources-resize");Un&&Un.addEventListener("mousedown",e=>{e.preventDefault();let i=e.clientX,c=b.querySelector(".ia-sources")?.offsetWidth||260,d=w=>{let x=Math.max(140,Math.min(600,c+(w.clientX-i)));b.style.setProperty("--ia-sources-width",x+"px")},h=()=>{document.removeEventListener("mousemove",d),document.removeEventListener("mouseup",h),b.classList.remove("resizing-sources"),Ae()};document.addEventListener("mousemove",d),document.addEventListener("mouseup",h),b.classList.add("resizing-sources")});let Mn=b.querySelector(".ia-browser-resize");Mn&&Mn.addEventListener("mousedown",e=>{e.preventDefault();let i=e.clientY,c=b.querySelector(".ia-browser")?.offsetHeight||220,d=w=>{let x=Math.max(120,Math.min(640,c+(w.clientY-i)));b.style.setProperty("--ia-browser-height",x+"px")},h=()=>{document.removeEventListener("mousemove",d),document.removeEventListener("mouseup",h),b.classList.remove("resizing-browser"),Ae()};document.addEventListener("mousemove",d),document.addEventListener("mouseup",h),b.classList.add("resizing-browser")});let Ce=Wt();if(Ce){let e=!ao;ao=!0,e&&(Ce._manualInit=!0,Ce.addEventListener("click",()=>{try{Ce.isLoggedIn||Zr()}catch{}},!0)),document.addEventListener("omp:reapply-gating",va);let i=!1,c=async d=>{$(f,"Loading library from your pod\u2026");let h=await co(d);return h.ok||$(f,`Couldn't load the pod library: ${h.err}. Staying on the local library.`),!!h.ok};document.addEventListener("sol-login",async d=>{let h=d.detail?.webId||Ce.webId||"";if(!h)return;let w=al();if(w){try{let x=(w.search||"")+(w.hash||"");x&&location.search+location.hash!==x&&Pt.replaceState(null,"",location.pathname+x)}catch{}to()}console.info("[omp] sol-login handler upgrade fired: webId=",h);try{Gr(!0),vt=!0,ct=!1,Ct=!1;let x=yt().find(k=>k.store&&!k.config.solid&&$t(k.config.url));if(x){try{eo(h,new URL(x.config.url,location.href).href)}catch{}Qe(x)}ln(),va(),$(f,`Signed in: ${h} \u2014 your library is now writable.`)}catch(x){console.warn("[omp] pod login upgrade failed:",x),$(f,`Signed in, but: ${x.message}.`)}if(e&&!i&&nl()){i=!0,setTimeout(async()=>{try{await Bn()}finally{i=!1}},1500);return}if(e&&!i&&ol()){i=!0,setTimeout(async()=>{try{await On()}finally{i=!1}},1500);return}}),document.addEventListener("sol-logout",()=>{Ye=null,Gr(!1),vt=!1,ct=!0,Ct=!1;let d=yt().find(h=>h.store&&!h.config.solid&&$t(h.config.url));d&&Qe(d),ln(),va(),$(f,"Signed out. Viewing in guest mode \u2014 you may browse, search, listen, and favourite anything.")}),e&&Promise.resolve().then(()=>Ce.initialize()).then(()=>document.dispatchEvent(new CustomEvent("omp:reapply-gating"))).catch(d=>console.warn("sol-login init skipped (no auth library?):",d?.message||d)),Ce.isLoggedIn||(ct=!0,$(f,"Viewing in guest mode. You may browse, search, listen, and favourite anything."))}let xr=b.querySelector(".ia-artist-search");if(xr){let e=xr.querySelector("input");xr.addEventListener("submit",async i=>{i.preventDefault();let c=e.value.trim();if(!c)return;let d=Be(),h=new URL("https://archive.org/search");h.searchParams.set("query",`creator:"${c}"`),h.searchParams.append("and[]",`mediatype:"${n()==="video"?"movies":"audio"}"`),aa(),ot.setSelection([],{notify:!1}),Ze.setSelection([],{notify:!1}),it.setSelection([],{notify:!1}),Qt(),et=[],Pa(`Searching \u201C${c}\u201D\u2026`),be.setMessage("Searching\u2026");let w=++Ia,x=[];try{x=await Ir(Cr(h.href),Mt,{mediaType:n()})}catch(T){console.error("find-artist search",T)}if(w!==Ia)return;let k={label:c,_lib:d?.config.id};if(et=x.map(T=>({...T,_artist:k})),!et.length){Pa(""),be.setMessage(`No audio results for \u201C${c}\u201D.`);return}Pa("Temporary search results \u2014 add tracks to a playlist to keep them."),An(),St(),$(f,`${et.length} result${et.length===1?"":"s"} for \u201C${c}\u201D.`)})}let na=Jn(he,{onSort:()=>{oa(),fe(),Ae()}});function ia(e){if(!e)return 0;let i=String(e).split(":").map(Number);if(i.length===2)return i[0]*60+i[1];if(i.length===3)return i[0]*3600+i[1]*60+i[2];let c=parseFloat(e);return isFinite(c)?c:0}function Zo(e,i,c){if(c==="time")return ia(e.time)-ia(i.time);if(c==="fav"){let w=Ea(e.url)?1:0,x=Ea(i.url)?1:0;return w-x}let d=(e[c]||"").toString(),h=(i[c]||"").toString();return d.localeCompare(h,void 0,{sensitivity:"base",numeric:!0})}function oa(){let{col:e,dir:i}=na.getSort();if(!e)return;let c=i==="asc"?1:-1;N=N.slice().sort((d,h)=>c*Zo(d,h,e)),U==="library"&&(ie=N)}let Rn=Vn(re,{onPlay:e=>{let i=N.find(c=>c.id===e);if(i){if(It==="random"&&wr("ordered"),n()==="video"){Sn(i);return}He(i)}},onRemove:(e,i)=>{Fn(e,i)},onEdit:(e,i)=>{es(e,i)},onFavourite:e=>Oo(e)});Ta(),document.addEventListener("omp:favourited",Ta);function Nn(e){return!e||!e.node?!1:rt()?!0:U&&Ie.has(U)?e.node.value.startsWith(U+"#"):!1}function es(e,i){let c=N.find(T=>T.id===e);if(!c)return;let d=c.albumUrl||"",h=/(?:^|\/\/)(?:www\.)?archive\.org\//.test(d),w=U&&Ie.has(U),x=[];Nn(c)&&x.push({id:"edit",label:"Edit\u2026"}),h&&x.push({id:"visit",label:"Visit on the Internet Archive"}),x.push({id:"remove",label:w?"Remove from playlist":"Remove from list",danger:!0});let k=T=>{if(T==="visit"){d&&window.open(d,"_blank","noopener");return}if(T==="remove"){Fn([e],{fromButton:!0});return}if(T==="edit"){ts(e);return}};if(x.length<=1){k(x[0]?.id||"remove");return}la(i,x,k)}async function ts(e){let i=N.find(w=>w.id===e);if(!i||!i.node){$(f,"Can't edit this track (no RDF node).");return}let c=Ft(U)||Be();if(!c)return;let d=Wi(c.store,i.node),h=U&&Ie.has(U);ni({values:{title:i.name,artist:i.artist,album:i.album},siblingCount:d,actions:[],onSave:async({title:w,artist:x,album:k})=>{let T=await Ki(c.store,c.baseURI,i.node,{title:w,artist:x,album:k});if(!Ue(T,`edit "${i.name}"`))return;let A=te.find(_=>_.node&&_.node.value===i.node.value);if(A&&(A.name=w,A.artist=x,A.album=k,A.label=[x,k,w].filter(Boolean).join(" \u2014 ")||w),k!=null)for(let _ of te)_.source&&i.albumUrl&&_.source===i.albumUrl&&(_.album=k,_.label=[_.artist,_.album,_.name].filter(Boolean).join(" \u2014 ")||_.name);if(h)sr(U),ta(U);else{for(let _ of N)_.node&&_.node.value===i.node.value&&(_.name=w,_.artist=x),k!=null&&i.albumUrl&&_.albumUrl===i.albumUrl&&(_.album=k);i.albumUrl&&Ut.delete(i.albumUrl),fe()}$(f,`Updated "${w}".`)}})}async function Fn(e,i={}){if(!e||!e.length)return;let c=new Set(e);if(U==="library"&&!Dt){ie=ie.filter(A=>!c.has(A.id)),N=ie,qe=kt(),fe(),Ae();return}if(U==="favorites"){if((i.fromButton||e.length>1)&&!confirm(e.length===1?"Remove this favourite from the communal wall?":`Remove ${e.length} favourites from the communal wall?`))return;let _=N.filter(E=>c.has(E.id));for(let E of _)await Ca(E.url);return}let d=U==="library"?Dt:null;if(i.fromButton||e.length>1){let A=d||U,_=Me.find(z=>z.id===A)?.label||(U==="favorites"?"Favorites":"this playlist"),E=e.length===1?`Remove this track from "${_}"?`:`Remove ${e.length} tracks from "${_}"?`;if(!confirm(E))return}let w=N.filter(A=>c.has(A.id)),x=U==="favorites"?Br(Be()?.baseURI):d||U,k=[];for(let A of w){let _=U==="favorites"?zo(A.url):Ft(x);if(!_)continue;let E=await Gi(_.store,_.baseURI,x,A.url);if(Ue(E,`remove "${A.name}" from playlist`)){k.push(A);for(let z=te.length-1;z>=0;z--)if(te[z].url===A.url&&te[z].topic===x){te.splice(z,1);break}}}let T=new Set(k.map(A=>A.id));N=N.filter(A=>!T.has(A.id)),d&&(ie=ie.filter(A=>!T.has(A.id))),k.length&&U!=="favorites"&&sr(x),fe()}Qn({audio:g,playBtn:ze,prevBtn:xe,nextBtn:Ke,seekSlider:C,timeCur:G,timeDur:Z,volumeSlider:L},{onPlayToggle:()=>{if(!Se){N[0]?He(N[0]):Ua();return}if(!g.src||g.src!==Se.url){He(Se);return}g.paused?g.play().catch(()=>{}):g.pause()},onPrev:()=>Qo(),onNext:()=>vr()}),g.addEventListener("volumechange",()=>Ae());let zn=0;g.addEventListener("timeupdate",()=>{let e=Date.now();e-zn<5e3||(zn=e,Ae())}),g.addEventListener("pause",()=>Ae());let sa=0,as=5;g.addEventListener("playing",()=>{sa=0}),g.addEventListener("error",()=>{if(!g.src||!Se)return;let e=g.error;if(console.warn("Audio error",e?.code,e?.message,"for",Se.url),sa++,sa>=as){$(f,`Stopped: ${sa} tracks in a row couldn't be played.`),ra(`Stopped \u2014 ${sa} items in a row couldn't be played. The source may be offline.`,{sticky:!0});return}$(f,`Skipped (couldn't play "${Se.name}")`),n()==="video"&&ra(`Can't play \u201C${Se.name}\u201D. The media may be unavailable or in an unsupported format.`),It==="random"?Ua():vr()}),g.addEventListener("ended",()=>{if(Vt==="one"){g.currentTime=0,g.play().catch(()=>{});return}if(It==="random"){Ua();return}vr()}),ma.addEventListener("click",()=>{at(!1),Ra()}),Y?.addEventListener("click",()=>{at(!1),Ra({url:"./assets/ia-help.html",title:"Help",useBundle:!1,size:"large"})}),Te?.addEventListener("click",()=>{at(!1),Ra({url:"./assets/ia-login-help.html",title:"Solid login help",useBundle:!1,size:"large"})}),Xe?.addEventListener("click",()=>{at(!1);let e=Be();if(!e?.store){$(f,"Enable a library to view deleted items.");return}for(let c of yt())Qe(c);let i=qt(e.baseURI);if(!Ie.has(i)){$(f,"Nothing has been deleted yet.");return}ut(i)});async function jn(){let e=location.href.split("#")[0].split("?")[0],i=/\/[^/]*\.[^/]+$/.test(e)?e:new URL("index.html",e.endsWith("/")?e:e+"/").href,c=await fetch(i),d=await c.text();if(!c.ok||!/<html[\s>]|<ia-player[\s>]|<script[\s>]/i.test(d))throw new Error(`won't install: ${i} returned ${c.status} and not HTML (${d.length} bytes). The app page must be reachable as a file, not a container listing.`);d=d.replace(/(?:\.?\/)?(?:dist\/)?ia-player(?:\.esm)?\.js/g,"./ia-player.js"),d=d.replace(/(<sol-default\b[^>]*?)\s+solid-kitchen\b(\s*=\s*(?:"[^"]*"|'[^']*'|\S+))?/gi,"$1").replace(/<script\b[^>]*>(?:(?!<\/script>)[\s\S])*?window\.SolidKitchen(?:(?!<\/script>)[\s\S])*?<\/script>\s*/gi,"").replace(/window\.SolidKitchen\s*=\s*true/gi,"window.SolidKitchen = false");let h="";for(let k of document.querySelectorAll("script[src]")){let T=k.getAttribute("src")||"";if(/ia-player(?:\.esm)?\.js(?:[?#]|$)/.test(T)){h=k.src;break}}h||(h=new URL("dist/ia-player.js",i).href);let w=await fetch(h),x=await w.text();if(!w.ok||x.length<1e3||!/customElements|function|=>/.test(x))throw new Error(`won't install: ${h} returned ${w.status} and not the JS bundle (${x.length} bytes).`);return[{relPath:"index.html",body:d,contentType:"text/html"},{relPath:"ia-player.js",body:x,contentType:"text/javascript"}]}async function rs(e){let i=e.baseURI,c=i.slice(0,i.lastIndexOf("/")+1),d=c.replace(/\/$/,"").split("/").pop()||"library",h=`libraries/${d}/`,w=e.config?.label||d;if(e.loadDocs)try{await e.loadDocs(Kr(e.store,e.baseURI))}catch(V){console.warn("[install] playlist force-load failed",V?.message||V)}let x=[],k=[],T=[];for(let V of Mi(e.store,e.baseURI)){if(!V.startsWith(c)){console.warn("[install] SKIP playlist outside library",V);continue}let ee=V.slice(c.length);try{let j=await fetch(V),pe=Oa(await j.text(),d,ee);x.push({relPath:h+ee,body:pe,contentType:"text/turtle",skipIfExists:!0}),k.push(`<./${ee}>`),T.push(V)}catch(j){console.warn("[install] gather playlist FAILED",V,j?.message||j)}}let A=[];for(let V of Ka(e.store,T)){if(!V.startsWith(c)){console.warn("[install] SKIP release outside library",V);continue}let ee=V.slice(c.length);try{let j=await fetch(V),pe=Oa(await j.text(),d,ee);x.push({relPath:h+ee,body:pe,contentType:"text/turtle",skipIfExists:!0}),A.push(`<./${ee}>`)}catch(j){console.warn("[install] gather release FAILED",V,j?.message||j)}}let _=A.map(V=>V.replace(/>$/,"#it>")),E=`@prefix dct: <http://purl.org/dc/terms/>.
@prefix dcat: <http://www.w3.org/ns/dcat#>.
<#it>
    a dcat:Catalog ;
...
<#it>
    ...
    dcat:dataset ${k.join(`,
                 `)}`:""} .
`,ae=[{relPath:h+"releases.ttl",body:E,contentType:"text/turtle"},{relPath:h+"playlists.ttl",body:z,contentType:"text/turtle"}];for(let V of["index.ttl","agents.ttl","genres.ttl"]){let ee=await fetch(c+V);if(!ee.ok)throw new Error(`couldn't read ${V} (${ee.status})`);let j=Oa(await ee.text(),d,V);ae.push({relPath:h+V,body:j,contentType:"text/turtle"})}return{files:[...ae,...x],podLibPrefix:h,title:w}}function ns(){let e=[...document.querySelectorAll("ia-player[src]")].map(i=>{try{return new URL(i.getAttribute("src"),location.href).href}catch{return null}}).filter(i=>i&&$t(i));if(!e.length){let i=t.find(c=>!c.solid&&$t(c.url));i&&e.push(new URL(i.url,location.href).href)}return[...new Set(e)]}async function Bn(){if(at(!1),!Ce||!Ce.isLoggedIn){rl(),Zr(),$(f,"Choose your Solid provider to sign in \u2014 the install resumes automatically once you\u2019re signed in."),cr()||$(f,'Open the gear menu and click "Log in" to sign in, then choose Install on my Pod again.');return}let e=Ce.webId,i=Ce.fetchFor(e),c=ns();if(!c.length){$(f,"No local library available to install.");return}let d=[];try{d=await jr(i,e)}catch{}d.length||(d=[new URL("/",e).href]);let h=d.map((j,pe)=>`  ${pe+1}. ${j}`).join(`
`),w=prompt(`Install Open Media Player \u2014 choose where it goes.

Enter a number, or type a full container URL:

`+h,"1");if(w==null||!w.trim())return;let x,k=parseInt(w,10);if(Number.isInteger(k)&&d[k-1]?x=d[k-1]:/^https?:\/\/.+/.test(w.trim())&&(x=w.trim()),!x){$(f,"Install cancelled \u2014 no valid location chosen.");return}let T=x.endsWith("/")?x:x+"/",A=prompt("Confirm or edit the install location:",new URL("open_media_player/",T).href);if(!A||!A.trim())return;let _=A.trim();_.endsWith("/")||(_+="/");let E=[];try{E=await jn()}catch(j){$(f,`Couldn't read the app files to install: ${j.message}`);return}let z=[];for(let j of c){let pe=a.find(Re=>Re.baseURI===j&&Re.store);if(!pe)try{pe=await pt({id:j,url:j,enabled:!0})}catch{pe=null}if(!pe||!pe.store){console.warn("[install] skipping unreadable library",j);continue}try{let Re=await rs(pe);E.push(...Re.files),z.push({podLibPrefix:Re.podLibPrefix,title:Re.title})}catch(Re){$(f,`Couldn't prepare ${j} to install: ${Re.message}`);return}}if(!z.length){$(f,"No readable libraries to install.");return}console.info(`[install] writing ${E.length} files (${z.length} libraries) to ${_}`),$(f,`Installing ${E.length} files to ${_}\u2026`);let ae=await Wr(i,_,E,(j,pe,Re)=>{(j===pe||j%10===0)&&$(f,`Installing ${j}/${pe}: ${Re}`)}),V=!1;try{let j=(await $i(i,e)).typeIndex;if(j||(j=await Ti(i,e)),j){for(let pe of z){let Re=_+pe.podLibPrefix+"index.ttl";await Ha(i,j,{id:"omp-pod-"+pe.podLibPrefix.replace(/[^a-z0-9]+/gi,"-").replace(/-+$/,""),url:Re,label:`${pe.title} (my pod)`}),eo(e,Re)}V=!0}}catch(j){console.warn("type-index record skipped:",j?.message||j)}let ee=V?" Registered in your type index.":" (type index not updated).";$(f,ae.ok?`Installed ${z.length} ${z.length===1?"library":"libraries"} \u2014 open ${_}index.html (${ae.put} written${ae.skipped?`, ${ae.skipped} kept`:""}).${ee}`:`Installed ${ae.put} files with ${ae.failed.length} problem(s): ${ae.failed.slice(0,3).join("; ")}${ee}`)}We?.addEventListener("click",Bn);async function On(){if(at(!1),!Ce||!Ce.isLoggedIn){il(),Zr(),$(f,"Choose your Solid provider to sign in \u2014 the app update resumes automatically once you\u2019re signed in."),cr()||$(f,'Open the gear menu and click "Log in" to sign in, then choose Update app on Pod again.');return}let e=Ce.webId,i=Ce.fetchFor(e),c="",d=el();if(d){let j=d.indexOf("libraries/");j>0&&(c=d.slice(0,j))}let h=[];try{h=await jr(i,e)}catch{}h.length||(h=[new URL("/",e).href]);let w=h.map((j,pe)=>`  ${pe+1}. ${j}`).join(`
`),x=prompt(`Update app on Pod \u2014 choose where the app lives.

Enter a number, or type a full container URL:

`+w,"1");if(x==null||!x.trim())return;let k,T=parseInt(x,10);if(Number.isInteger(T)&&h[T-1]?k=h[T-1]:/^https?:\/\/.+/.test(x.trim())&&(k=x.trim()),!k){$(f,"Update cancelled \u2014 no valid location chosen.");return}let A=k.endsWith("/")?k:k+"/",_=(()=>{let j=location.href.split("#")[0].split("?")[0];return j.endsWith("/")?j:j.slice(0,j.lastIndexOf("/")+1)})(),E=(()=>{try{if(new URL(_).origin===new URL(A).origin&&!/^https?:\/\/(localhost|127\.0\.0\.1)/.test(_))return _}catch{}if(c)try{if(new URL(c).origin===new URL(A).origin)return c}catch{}return new URL("open_media_player/",A).href})(),z=prompt("Confirm the existing install location to overwrite:",E);if(!z||!z.trim())return;let ae=z.trim();ae.endsWith("/")||(ae+="/");let V;try{V=await jn()}catch(j){$(f,`Couldn't read the app files: ${j.message}`);return}$(f,`Updating app (${V.length} files) at ${ae}\u2026`);let ee=await Wr(i,ae,V,(j,pe,Re)=>$(f,`Updating ${j}/${pe}: ${Re}`));$(f,ee.ok?`App updated \u2014 hard-reload ${ae}index.html (${ee.put} files written).`:`App update: ${ee.put} written, ${ee.failed.length} problem(s): ${ee.failed.slice(0,3).join("; ")}`)}ha?.addEventListener("click",On),je?.addEventListener("click",()=>{at(!1),ei({filter:Mt,onSave:e=>{Mt=e===null?{...La}:e,yo(Mt),xt.clear(),Ut.clear(),De(),$(f,"Filter updated.")}})}),tt?.addEventListener("click",e=>{if(e.stopPropagation(),!N.length){$(f,"Nothing to randomize \u2014 the tracklist is empty.");return}let i=N;for(let c=i.length-1;c>0;c--){let d=Math.floor(Math.random()*(c+1));[i[c],i[d]]=[i[d],i[c]]}na?.clear?.(),fe(),$(f,`Randomized ${i.length} track${i.length===1?"":"s"}.`),Ae()}),pa?.addEventListener("click",e=>{if(e.stopPropagation(),U!=="library"){$(f,"Clear tracklist only applies to the Library view. Use the playlist menu to delete a playlist.");return}g.pause(),g.removeAttribute("src"),g.load(),ie=[],N=[],Se=null,be.setSelection([],{notify:!1}),Rn?.clearSelection?.(),qe=kt(),fe(),Ma(D,""),$(f,"Library queue cleared."),Ae()}),Ee?.addEventListener("click",async()=>{if(at(!1),!N.length){$(f,"Nothing to save \u2014 pick some albums first.");return}let e=Be();if(!e){$(f,"Enable a library to save playlists.");return}let i=`Playlist ${Me.length+1}`,c=prompt("Save current tracks as a playlist named:",i);if(!c||!c.trim())return;let d=c.trim();$(f,`Saving playlist "${d}"\u2026`);try{let w=(await Yr(e.store,e.baseURI,d)).id;Me.push({id:w,label:d,_lib:e.config.id}),Ie.add(w);let x=N.map(T=>({label:[T.artist,T.album,T.name].filter(Boolean).join(" \u2014 ")||T.name,url:T.url,source:T.albumUrl})),k=await Wa(e.store,e.baseURI,w,x,{inlineTracks:!rt()});N.forEach((T,A)=>{te.push({node:k.nodes?.[A],label:x[A].label,topic:w,url:T.url,source:T.albumUrl,_lib:e.config.id})}),$(f,`Saved playlist "${d}" (${N.length} track${N.length===1?"":"s"}). Click it in Sources to view.`),Pe()}catch(h){console.error("Save playlist failed:",h),$(f,`Could not save playlist: ${h.message}`)}}),wr("ordered"),Dn("off"),sn(),Oe(),ge(),be.setMessage(rr().chooseArtist),fe(),va(),bo();function is(){for(let e of yt()){if(!e.loadDocs)continue;let i=Kr(e.store,e.baseURI);i.length&&e.loadDocs(i).then(c=>{if(c&&(Qe(e),Pe(),ge(),Jt&&Ie.has(Jt)&&U==="library")){let d=Jt;Jt=null,it.setSelection([d],{notify:!1}),ut(d)}}).catch(c=>console.warn("background playlist load failed:",c))}}return(window.requestIdleCallback||(e=>setTimeout(e,300)))(()=>is()),r.appAction=e=>{let i={help:".gear-help-link",about:".gear-help",loginHelp:".gear-login-help",filters:".gear-filters",viewDeleted:".gear-view-deleted",installPod:".gear-install-pod",updateApp:".gear-update-app"}[e];i&&b.querySelector(i)?.click()},r.appState=()=>({guest:!rt(),real:ya(),webId:ya()&&Wt()?.webId||"",mediaType:n()}),r.getMediaElement=()=>g,b}var Ya="ia-player:libraries";function Xi(){return"lib-"+(crypto.randomUUID?.()??Date.now().toString(36)+Math.random().toString(36).slice(2,6))}function Qi(t){return String(t).toLowerCase().replace(/\s+/g,"_").replace(/[^a-z0-9_]/g,"").replace(/_+/g,"_").replace(/^_|_$/g,"")||"library"}function Xs(t){if(typeof t!="string")return t;let a=t.replace("/ia-music-library/","/libraries/internet_archive_music/");return(a==="./ia-music.ttl"||a.endsWith("/ia-music.ttl"))&&(a=a.replace(/(^|\/)ia-music\.ttl$/,(r,n)=>`${n}libraries/internet_archive_music/index.ttl`)),a}function $t(t){try{return new URL(t,location.href).origin===location.origin}catch{return!1}}function Qs(t){try{let a=localStorage.getItem(Ya);if(a){let r=JSON.parse(a),n=Array.isArray(r)?r.filter(s=>s&&!s.solid):[];if(n.length){let s=!1;for(let o of n){let l=Xs(o.url);l!==o.url&&(o.url=l,s=!0),o.id==="default"&&o.label==="Internet Archive"&&(o.label="Internet Archive Music",s=!0),o.enabled=$t(o.url)}return s&&nn(n),n}}}catch(a){console.warn("Could not read library configs from localStorage:",a)}return[{id:"default",label:"Internet Archive Music",url:t,enabled:!0}]}function nn(t){try{localStorage.setItem(Ya,JSON.stringify((t||[]).filter(a=>a&&!a.solid)))}catch(a){console.warn("Could not write library configs to localStorage:",a)}}var en="omp:lib-enabled";function Zs(t,a){if(t)try{let r=JSON.parse(localStorage.getItem(en)||"{}");r[t]=!!a,localStorage.setItem(en,JSON.stringify(r))}catch(r){console.warn("rememberLibEnabled failed:",r)}}function ro(t,a){try{let r=JSON.parse(localStorage.getItem(en)||"{}");return t in r?!!r[t]:a}catch{return a}}var Zi="omp:pod-library",no="omp:pod-library:last";function eo(t,a){try{let r=JSON.parse(localStorage.getItem(Zi)||"{}");r[t]=a,localStorage.setItem(Zi,JSON.stringify(r))}catch(r){console.warn("podLibRemember failed:",r)}try{localStorage.setItem(no,a)}catch{}}function el(){try{return localStorage.getItem(no)||null}catch{return null}}var Ja="omp:auth-inflight",tl=12e4;function Zr(){try{localStorage.setItem(Ja,JSON.stringify({search:location.search,hash:location.hash,t:Date.now()}))}catch{}}function al(){try{let t=JSON.parse(localStorage.getItem(Ja)||"null");return t?Date.now()-(t.t||0)>tl?(localStorage.removeItem(Ja),null):t:null}catch{return null}}function to(){try{localStorage.removeItem(Ja)}catch{}}var tn="omp:install-pending";function rl(){try{localStorage.setItem(tn,"1")}catch{}}function nl(){try{let t=localStorage.getItem(tn);return t&&localStorage.removeItem(tn),!!t}catch{return!1}}var an="omp:updateapp-pending";function il(){try{localStorage.setItem(an,"1")}catch{}}function ol(){try{let t=localStorage.getItem(an);return t&&localStorage.removeItem(an),!!t}catch{return!1}}async function pt(t){try{let a=!!t.solid||$t(t.url),{store:r,baseURI:n,loadDocs:s}=await Ai(t.url,{shared:a,lazyReleases:!0,lazyPlaylists:!0}),o=Pi(r,n),{genres:l,bookmarks:u}=qr(r,n,o),p=Hr(r,n);return{config:t,store:r,baseURI:n,loadDocs:s,mediaType:o,genres:l,bookmarks:u,playlists:p,error:null}}catch(a){return console.error("Failed to load library",t.url,a),{config:t,store:null,baseURI:null,loadDocs:null,mediaType:"audio",genres:[],bookmarks:[],playlists:[],error:a.message}}}var ao=!1;async function Va(t,a){try{console.info("[omp] BUILD","0.1.0 2026-06-08T19:59:06.994Z")}catch{}if(oi(t),a.length>1){let r=a.map(n=>ro(n.url,n.enabled));r.filter(Boolean).length===1&&a.forEach((n,s)=>{n.enabled=r[s]})}try{let r=o=>({config:o,store:null,baseURI:null,genres:[],bookmarks:[],playlists:[],error:null,unloaded:!0}),n=await Promise.all(a.map(o=>o.enabled?pt(o):Promise.resolve(r(o)))),s=Js({libraryConfigs:a,libs:n,host:t});li(t,s)}catch(r){console.error("Initialization error:",r),si(t,r.message)}}var rn=class extends HTMLElement{static get observedAttributes(){return["src","source"]}connectedCallback(){this._mounted||(this._mounted=!0,!this.hasAttribute("defer")&&this.ensureLoaded())}ensureLoaded(){this._loaded||(this._loaded=!0,this._loadFromConfig())}attributeChangedCallback(a,r,n){!this._mounted||a!=="src"&&a!=="source"||r===n||localStorage.getItem(Ya)||this._loadFromConfig()}_loadFromConfig(){let a=this.getAttribute("src")||this.getAttribute("source"),r=this.getAttribute("storage-ns");if(r&&a){Va(this,[{id:r,label:r,url:a,enabled:!0}]);return}if(!a&&!localStorage.getItem(Ya)){ii(this,s=>{let o=[{id:"default",label:"Internet Archive Music",url:s,enabled:!0}];nn(o),Va(this,o)});return}let n=Qs(a||"./libraries/internet_archive_music/index.ttl");Va(this,n)}reload(a){Va(this,a)}};customElements.get("ia-player")||customElements.define("ia-player",rn);vi();
