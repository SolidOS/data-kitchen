#!/usr/bin/env node
/**
 * html2rdf — import an edited shell snapshot back into ui-data/data-kitchen-main-menu.ttl.
 *
 ...
 * mappings stay single-sourced) and MERGE the result into ui-data/data-kitchen-main-menu.ttl —
 ...
 * NOT imported (edit ui-data/data-kitchen-main-menu.ttl#Chrome directly).
 *
...
console.log(`imported ${tabs.length} tabs + ${bar.length} bar items from ${args[0] || 'tools/conversion/shell.html'} into ui-data/data-kitchen-main-menu.ttl`);
console.log('note: the chrome block is not imported — edit ui-data/data-kitchen-main-menu.ttl#Chrome directly.');
