      ...
      submenu: [
        {
          label: "DataBrowser",
          click: async () => {
            mainWindow.webContents.send("gotoSubject", cfg.startPage);
          },
        },
        {
          label: "File Manager",
          enabled: false,
          click: async () => {
            mainWindow.webContents.send("gotoSubject", "none", "fileManager");
          },
        },
        {
          label: "SPARQL Query",
          enabled: false,
          click: async () => {
            mainWindow.webContents.send("gotoSubject", "none", "queryForm");
          },
        },
        {
          label: "Exit",
    ...
    // { role: 'toolsMenu' }
    {
      ...
      submenu: [
        ...
        },
        {
          ...
          enabled: false,
          click: async () => {
            mainWindow.webContents.send("https://jeff-zucker.github.io/data-kitchen.html");
          },
        },
        { role: "toggledevtools" },
      ],
    ...
    // { role: 'bookmarksMenu' }
    {
      ...
      submenu: [
        ...
        },
        {
          ...
          click: async () => {
            mainWindow.loadURL("https://jeff-zucker.solidcommunity.net/public/");
          },
        },
        {
          label: "My inrupt.net pod",
          click: async () => {
            mainWindow.loadURL("https://pod.inrupt.com/jeff-zucker/public/");
          },
        },
      ],
    },
      ...
      submenu: [
        {
          ...
          enabled: false,
          click: async () => {
            mainWindow.webContents.send("gotoSubject", "assets/welcome.html");
          },
        },
        {
          enabled: false,
          ...
          click: async () => {
            mainWindow.webContents.send(
              "gotoSubject",
              "https://github.com/solidos/userguide",
              "webBrowser"
            );
          },
        },
        {
          ...
          click: async () => {
            mainWindow.webContents.send(
              "gotoSubject",
              "https://github.com/jeff-zucker/data-kitchen/issues",
              "webBrowser"
            );
          },
        },
